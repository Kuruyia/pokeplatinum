...
void ov6_02242AF0(FieldSystem *fieldSystem)
{
    ...
    MapPropManager_LoadOne(fieldSystem->mapPropManager, fieldSystem->areaDataManager, 475, &v2, NULL, fieldSystem->mapPropAnimationManager);
}
...
static BOOL ov6_02242C5C(FieldTask *taskMan)
{
...

    {
        ...
        v4 = MapPropManager_FindLoadedPropByModelID(fieldSystem->mapPropManager, MAP_PROP_MODEL_ID_GREAT_MARSH_TRAIN);
        v5 = MapProp_GetRenderObj(v4);
        v3 = AreaDataManager_GetMapPropModelFile(MAP_PROP_MODEL_ID_GREAT_MARSH_TRAIN, fieldSystem->areaDataManager);
        v2 = NNS_G3dGetMdlByIdx(NNS_G3dGetMdlSet(*v3), 0);

        ov5_021D41C8(fieldSystem->mapPropAnimationManager, fieldSystem->mapPropOneShotAnimationManager, 16, MAP_PROP_MODEL_ID_GREAT_MARSH_TRAIN, v5, v2, AreaDataManager_GetMapPropTexture(fieldSystem->areaDataManager), 1, -1, 0);
        MapPropOneShotAnimationManager_PlayAnimation(fieldSystem->mapPropOneShotAnimationManager, 16, 0);
    }
        (v1->unk_05)++;
        break;
    case 1:
...

    {
        ...
        v6 = MapPropManager_FindLoadedPropByModelID(fieldSystem->mapPropManager, MAP_PROP_MODEL_ID_GREAT_MARSH_TRAIN);
    ...
    case 4:
        MapPropOneShotAnimationManager_UnloadAnimationByTag(fieldSystem->mapPropAnimationManager, fieldSystem->mapPropOneShotAnimationManager, 16);
        (v1->unk_05)++;
        break;
    case 5:
        Heap_FreeToHeap(v1);
