...
static BOOL ov6_02247DAC(FieldTask *param0)
{
    ...
    case 1: {
        ...
        v1->unk_10[v1->unk_0D] = MapPropManager_LoadOne(fieldSystem->mapPropManager, fieldSystem->areaDataManager, MAP_PROP_MODEL_ID_POKECENTER_HEALING_MACHINE_MINI_POKEBALL, &v7, &v8, fieldSystem->mapPropAnimationManager);
        v5 = MapPropManager_GetLoadedPropSafely(fieldSystem->mapPropManager, v1->unk_10[v1->unk_0D]);
        v6 = MapProp_GetRenderObj(v5);
        ov5_021D4220(fieldSystem->mapPropOneShotAnimationManager, 0x10, v1->unk_0D, v6);
        (v1->unk_0F)++;
    } break;
    case 2:
        if (v1->unk_0E < 15) {
    ...
    case 3:
        ...
        break;
    case 4:
        if (ov5_021D42F0(fieldSystem->mapPropOneShotAnimationManager, 0x10)) {
            u8 v9;
