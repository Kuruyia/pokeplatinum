...
void ov6_02247F5C(FieldSystem *fieldSystem)
{
    ...
    if (!SystemFlag_CheckFreedGalacticHQPokemon(SaveData_GetVarsFlags(fieldSystem->saveData))) {
        v0 = MapPropAnimationManager_GetAnimation(496, 1, fieldSystem->mapPropAnimationManager);
        MapPropAnimation_SetLoopCount(v0, 1);
        MapPropAnimation_SetAnimationPaused(v0, 1);
    } else {
        v0 = MapPropAnimationManager_GetAnimation(496, 0, fieldSystem->mapPropAnimationManager);
        MapPropAnimation_SetAnimationPaused(v0, 1);
...
static BOOL ov6_02247FD0(FieldTask *param0)
{
    ...
    switch (*v0) {
    case 0:
        v1 = MapPropAnimationManager_GetAnimation(496, 0, fieldSystem->mapPropAnimationManager);
        ...
        break;
    case 1:
        v1 = MapPropAnimationManager_GetAnimation(496, 1, fieldSystem->mapPropAnimationManager);
