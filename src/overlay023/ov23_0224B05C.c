    ...
    for (v0 = 0; v0 < 17; v0++) {
        ...
        if (Unk_ov23_022577AC->unk_132A[v0] != (u8)-1) {
...

            {
                ...
                Unk_ov23_022577AC->unk_12D5[v0] = MapPropManager_LoadOne(Unk_ov23_022577AC->fieldSystem->mapPropManager, Unk_ov23_022577AC->fieldSystem->areaDataManager, 429 + v3, &v6, NULL, Unk_ov23_022577AC->fieldSystem->mapPropAnimationManager);
            }
        }
    }
}
...
static void ov23_0224D54C(UnkStruct_ov23_0224D54C *param0)
{
    ...
    MapPropManager_LoadOne(Unk_ov23_022577AC->fieldSystem->mapPropManager, Unk_ov23_022577AC->fieldSystem->areaDataManager, 317 + param0->unk_05, &v0, NULL, Unk_ov23_022577AC->fieldSystem->mapPropAnimationManager);
}
