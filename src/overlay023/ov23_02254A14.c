...
static void ov23_02254A14(FieldSystem *fieldSystem, const int param1, UnkStruct_ov23_02256098 *param2)
{
    ...
    v0->unk_10 = MapPropManager_LoadOne(fieldSystem->mapPropManager, fieldSystem->areaDataManager, ov23_02255E14(fieldSystem, param1), &v1, NULL, fieldSystem->mapPropAnimationManager);
    v0->unk_00.unk_00 = 16;
    v0->unk_00.unk_04 = 13;
...
static void ov23_02255D78(FieldSystem *fieldSystem, UnkStruct_ov23_02255BF4 *param1)
{
    ...
    for (v3 = 0; v3 < 32; v3++) {
        ...
        v5->unk_10 = MapPropManager_LoadOne(fieldSystem->mapPropManager, fieldSystem->areaDataManager, v0, &v4, NULL, fieldSystem->mapPropAnimationManager);
    }
}
