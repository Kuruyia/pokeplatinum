...
static void SkyboxCloudSpritesUpdateTask(SysTask *param0, void *param1);
...
static void InitRunningEvent(DistWorldSystem *param0, const DistWorldEventCmd *param1);
...
static void CreateEventHandlerTask(DistWorldSystem *param0, const DistWorldEventCmd *param1);
...
const DistWorldEventCmd sMapEventB4F_Waterfall[];
const DistWorldEventCmd sMapEventB5F_Waterfall[];
...
static void InitSkyboxClouds(DistWorldSystem *system, DistWorldSkyboxClouds *clouds, NARC *etcNARC)
{
    ...
    clouds->updateTask = SysTask_Start(SkyboxCloudSpritesUpdateTask, clouds, 65535);
}
...
static void SkyboxCloudSpritesUpdateTask(SysTask *sysTask, void *sysTaskParam)
{
...
static void CreateEventHandlerTask(DistWorldSystem *system, const DistWorldEventCmd *cmds)
{
...
{
    DistWorldEventCmdCascadeDownRunData *runData = ResetRunningEventDataBuffer(system, sizeof(DistWorldEventCmdCascadeDownRunData));
...
{
    MapObject *playerMapObj = Player_MapObject(system->fieldSystem->playerAvatar);
    DistWorldEventCmdCascadeDownRunData *runData = GetRunningEventDataBuffer(system);
    DistWorldEventCmdCascadeBaseRunData *baseRunData = &runData->base;
...
static int EventCmdCascadeUp_Init(DistWorldSystem *system, FieldTask *task, u16 *cmdState, const void *params)
{
    ...
    DistWorldEventCmdCascadeUpRunData *runData = ResetRunningEventDataBuffer(system, sizeof(DistWorldEventCmdCascadeUpRunData));
    DistWorldEventCmdCascadeBaseRunData *baseRunData = &runData->base;
    PlayerAvatar *playerAvatar = system->fieldSystem->playerAvatar;
    MapObject *playerMapObj = Player_MapObject(playerAvatar);
...
{
    MapObject *playerMapObj = Player_MapObject(system->fieldSystem->playerAvatar);
    DistWorldEventCmdCascadeUpRunData *runData = GetRunningEventDataBuffer(system);
    DistWorldEventCmdCascadeBaseRunData *baseRunData = &runData->base;
...
{
    DistWorldEventCmdShowUxieBoulderTutoRunData *runData = ResetRunningEventDataBuffer(system, sizeof(DistWorldEventCmdShowUxieBoulderTutoRunData));
...
{
    DistWorldEventCmdShowUxieBoulderTutoRunData *runData = GetRunningEventDataBuffer(system);
...
{
    DistWorldEventCmdShowAzelfBoulderTutoRunData *runData = ResetRunningEventDataBuffer(system, sizeof(DistWorldEventCmdShowAzelfBoulderTutoRunData));
...
{
    DistWorldEventCmdShowAzelfBoulderTutoRunData *runData = GetRunningEventDataBuffer(system);
...
{
    DistWorldEventCmdShowMespritBoulderTutoRunData *runData = ResetRunningEventDataBuffer(system, sizeof(DistWorldEventCmdShowAzelfBoulderTutoRunData));
...
{
    DistWorldEventCmdShowMespritBoulderTutoRunData *runData = GetRunningEventDataBuffer(system);
...
static const DistWorldEventCmdHandler *sEventCmdHandlers[EVENT_CMD_KIND_COUNT] = {
    ...
    [EVENT_CMD_KIND_CASCADE_UP] = sEventCmdCascadeUpHandlers,
...
static const DistWorldEventCmdSetDistortionWorldProgressParams sMapEventCmdParams1F_1_2 = {
    .progress = 0x2
};
...
static const DistWorldEventCmdStartScriptParams sMapEventCmdParamsB1F_1_1 = {
    .scriptID = 0x3
};

static const DistWorldEventCmdSetDistortionWorldProgressParams sMapEventCmdParamsB1F_1_2 = {
    .progress = 0x4
};

static const DistWorldEventCmdAddMapObjWithLocalIDParams sMapEventCmdParamsB1F_1_3 = {
...
static const DistWorldEventCmdStartScriptParams sMapEventCmdParamsB3F_1_1 = {
    .scriptID = 0x2
};

static const DistWorldEventCmdSetDistortionWorldProgressParams sMapEventCmdParamsB3F_1_2 = {
    .progress = 0x6
};
...
static const DistWorldEventCmdSetGiratinaAnimationFlagParams sMapEventCmdParamsB4F_1_2 = {
...
static const DistWorldEventCmdSetGiratinaAnimationFlagParams sMapEventCmdParamsB4F_2_2 = {
...
static const DistWorldEventCmd sMapEventB5F_Waterfall[] = {
    {
        .kind = EVENT_CMD_KIND_CASCADE_UP,
...
static const DistWorldEventCmdStartScriptParams sMapEventCmdParamsB7F_1_1 = {
    .scriptID = 0x4
};

static const DistWorldEventCmdSetDistortionWorldProgressParams sMapEventCmdParamsB7F_1_2 = {
    .progress = 0x9
};
...
static const DistWorldEventCmdStartScriptParams sMapEventCmdParamsGiratinaRoom_3_1 = {
    .scriptID = 0x7
};
...
static const DistWorldEventCmdSetDistortionWorldProgressParams sMapEventCmdParamsGiratinaRoom_3_3 = {
    .progress = 0xB
};
...
static const DistWorldEventCmdSetDistortionWorldProgressParams sMapEventCmdParamsGiratinaRoom_4_2 = {
    .progress = 0xC
};
...
static const DistWorldEventCmdSetDistortionWorldProgressParams sMapEventCmdParamsGiratinaRoom_5_1 = {
    .progress = 0xD
};

static const DistWorldEventCmdStartScriptParams sMapEventCmdParamsGiratinaRoom_5_2 = {
    .scriptID = 0x8
};
