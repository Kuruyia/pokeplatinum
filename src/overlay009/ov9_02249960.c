...
#define UXIE_BOULDER_TUTO_HOVER_LOOP_COUNT          3
...
#define SPRITE_MIN_DARKNESS 0
#define SPRITE_MAX_DARKNESS 12
...
#define GIRATINA_ROOM_PLAY_APPEARANCE_SKYBOX_DARKNESS_TARGET    (FX32_ONE * SPRITE_MAX_DARKNESS)
...
enum EventCommandSetMapObjectAnimationState {
...
enum EventCommandMovePlatformState {
...
enum EventCommandShowGiratinaShadowState {
    EVENT_CMD_SHOW_GIRATINA_SHADOW_STATE_LOAD = 0,
    EVENT_CMD_SHOW_GIRATINA_SHADOW_STATE_FINISH,
    EVENT_CMD_SHOW_GIRATINA_SHADOW_STATE_COUNT,
};

enum EventCommandShowUxieBoulderTutoState {
    ...
    EVENT_CMD_SHOW_UXIE_BOULDER_TUTO_STATE_COUNT,
};

enum EventCommandShowAzelfBoulderTutoState {
    ...
    EVENT_CMD_SHOW_AZELF_BOULDER_TUTO_STATE_COUNT,
};

enum EventCommandShowMespritBoulderTutoState {
...
enum EventCommandShowGiratinaRoomPlatformsState {
...
enum EventCommandHideGiratinaRoomPlatformsState {
...
enum EventCommandPlayGiratinaRoomAppearanceState {
...
typedef struct DistWorldEventCommandMovePlatformParams {
    u16 platformIndex;
    u16 movePlayer;
    u16 dummy04;
    s16 finalTileXOffset;
    ...
    s16 finalTileZOffset;
    VecFx32 posDelta;
} DistWorldEventCommandMovePlatformParams;

typedef struct DistWorldEventCommandSetMapObjectAnimationParams {
    u32 mapObjLocalID;
    enum MovementAction movementAction;
} DistWorldEventCommandSetMapObjectAnimationParams;
...
typedef struct DistWorldEventCommandSetMapObjectAnimationRunData {
    int dummy00;
} DistWorldEventCommandSetMapObjectAnimationRunData;

typedef struct DistWorldEventCommandMovePlatformRunData {
    VecFx32 currPosOffset;
    VecFx32 finalPosOffset;
    VecFx32 posDelta;
    DistWorldMovingPlatformPropAnimator *animator;
    ...
    fx32 vibrationYDelta;
    u32 vibrationAnimStep;
} DistWorldEventCommandMovePlatformRunData;
...
typedef struct DistWorldGiratinaShadowProp {
    ...
    u16 state;
    u16 animStopped;
    int currentMovementAnimStep;
    BOOL animFinished;
    Simple3DRotationAngles rotation;
...
typedef struct DistWorldEventCommandSetGiratinaAnimationFlagParams {
    enum GiratinaShadowAnimation anim;
} DistWorldEventCommandSetGiratinaAnimationFlagParams;

typedef struct EventCommandPersistedBoulderPuzzleFlagParams {
    u32 flagIndex;
} EventCommandPersistedBoulderPuzzleFlagParams;

typedef struct EventCommandPlayGiratinaRoomAppearanceRunData {
    fx32 currSpriteDarkness;
    fx32 currSkyboxDarkness;
    VecFx32 currGiratinaPosOffset;
    int currDelay;
    MapObject *giratinaMapObj;
    GXRgb giratinaSpritePalette[PALETTE_SIZE];
} EventCommandPlayGiratinaRoomAppearanceRunData;

typedef struct DistWorldEventCommandShowUxieBoulderTutoRunData {
    int currHoverStep;
    int currHoverStepDelta;
    int currHoverLoop;
    fx32 finalUxieY;
    fx32 currDescendYDelta;
    VecFx32 currUxiePosOffset;
    MapObject *uxieMapObj;
} DistWorldEventCommandShowUxieBoulderTutoRunData;

typedef struct DistWorldEventCommandShowAzelfBoulderTutoRunData {
    fx32 currDescendYDelta;
    VecFx32 currAzelfPosOffset;
    SysTask *azelfAnimTask;
    MapObject *azelfMapObj;
} DistWorldEventCommandShowAzelfBoulderTutoRunData;

typedef struct DistWorldEventCommandShowMespritBoulderTutoRunData {
    fx32 currDescendYDelta;
    VecFx32 currMespritPosOffset;
    SysTask *mespritAnimTask;
    SysTask *playerAnimTask;
    MapObject *mespritMapObj;
} DistWorldEventCommandShowMespritBoulderTutoRunData;

typedef struct EventCommandShowGiratinaRoomPlatformsRunData {
    s16 currGhostPropGroup;
    s16 currDelay;
} EventCommandShowGiratinaRoomPlatformsRunData;

typedef struct EventCommandHideGiratinaRoomPlatformsRunData {
    s16 currGhostPropGroup;
    s16 currDelay;
} EventCommandHideGiratinaRoomPlatformsRunData;
...
static void SetPersistedMovingPlatformFlags(DistWorldSystem *param0, u32 param1);
static void SetPersistedMovingPlatformFlag(DistWorldSystem *param0, u32 param1);
static void ClearPersistedMovingPlatformFlag(DistWorldSystem *param0, u32 param1);
static BOOL CheckPersistedMovingPlatformFlag(DistWorldSystem *param0, u32 param1);
static void SetPersistedBoulderPuzzleFlag(DistWorldSystem *param0, u32 param1);
static void ClearPersistedBoulderPuzzleFlag(DistWorldSystem *param0, u32 param1);
static BOOL CheckPersistedBoulderPuzzleFlag(DistWorldSystem *param0, u32 param1);
...
static BOOL HasActiveGhostProp2(DistWorldSystem *param0, u32 param1);
static BOOL HasActiveGhostPropAnim(DistWorldSystem *param0, u32 param1);
...
static BOOL HandleElevatorPlatformPropAnimatorAt(DistWorldSystem *param0, int param1, int param2, int param3);
static void CreateElevatorPlatformHandlerTask(DistWorldSystem *param0, DistWorldMovingPlatformPropAnimator *param1);
static BOOL CallElevatorPlatformHandler(FieldTask *param0);
...
static void FreeUnusedPropRenderers(DistWorldSystem *param0);
...
static void ResetMovingPlatformManager(DistWorldSystem *param0);
static void FinishAllMovingPlatformPropAnimators(DistWorldSystem *param0);
static void FinishMovingPlatformPropAnimatorForMap(DistWorldSystem *param0, u32 param1);
static void InitMovingPlatformPropsForCurrentAndNextMaps(DistWorldSystem *param0);
static void InitMovingPlatformPropsForMap(DistWorldSystem *param0, u32 param1);
static void InitMovingPlatformPropsForMapEx(DistWorldSystem *param0, const DistWorldMovingPlatformMapTemplates *param1, u32 param2);
static void InitSpecificMovingPlatformPropForMap(DistWorldSystem *param0, u32 param1, int param2);
static DistWorldMovingPlatformPropAnimator *FindUnusedMovingPlatformPropAnimator(DistWorldSystem *param0);
static DistWorldMovingPlatformPropAnimator *GetAnimatorForMovingPlatform(DistWorldSystem *param0, u32 param1, u32 param2);
static const DistWorldMovingPlatformMapTemplates *GetMovingPlatformsTemplatesForMap(u32 param0);
static const DistWorldMovingPlatformTemplate *GetMovingPlatformTemplateForMap(u32 param0, u32 param1);
static const DistWorldElevatorPlatformPath *GetMovingPlatformElevatorPath(u32 param0);
static MapObject *AddMovingPlatformMapObject(DistWorldSystem *param0, int param1, int param2, int param3, int param4, int param5, u32 param6);
static void DistWorldMovingPlatformPropAnimator_InitFromMapObject(DistWorldSystem *param0, DistWorldMovingPlatformPropAnimator *param1, MapObject *param2);
static OverworldAnimManager *InitAnimManagerForMovingPlatform(DistWorldSystem *param0, DistWorldMovingPlatformPropAnimator *param1);
static void DistWorldMovingPlatformPropAnimator_InitFromTemplate(DistWorldSystem *param0, DistWorldMovingPlatformPropAnimator *param1, const DistWorldMovingPlatformTemplate *param2, u32 param3);
static void DistWorldMovingPlatformPropAnimator_Finish(DistWorldSystem *param0, DistWorldMovingPlatformPropAnimator *param1);
static void DistWorldMovingPlatformPropAnimator_FinishAndDeleteMapObject(DistWorldSystem *param0, DistWorldMovingPlatformPropAnimator *param1);
static void DistWorldMovingPlatformPropAnimator_ChangeMaps(DistWorldSystem *param0, DistWorldMovingPlatformPropAnimator *param1, u32 param2);
static void ov9_0224E0DC(DistWorldMovingPlatformPropAnimator *param0, BOOL param1);
static BOOL HasActiveMovingPlatformProp2(DistWorldSystem *param0, u32 param1);
static BOOL HasActiveMovingPlatformPropAnim(DistWorldSystem *param0, u32 param1);
...
static void AddMapObjectsForCurrentAndNextMap(DistWorldSystem *param0);
static void Dummy0224EE6C(DistWorldSystem *param0);
static void DeleteMapObject(DistWorldSystem *param0, MapObject *param1);
static MapObject **FindFreeMapObjectSlot(DistWorldSystem *param0);
static BOOL CheckFlagConditionForObjectEvent(DistWorldSystem *param0, const DistWorldObjectEvent *param1, BOOL param2);
static BOOL AddMapObjectFromEvent(DistWorldSystem *param0, MapObject **param1, const DistWorldObjectEvent *param2, u32 param3, u16 param4);
static BOOL AddMapObjectsFromIter(DistWorldSystem *param0, const DistWorldObjectEvent **param1, u32 param2);
static void AddMapObjectsForMap(DistWorldSystem *param0, u32 param1);
static void DeleteMapObjectsForMap(DistWorldSystem *param0, u32 param1);
static MapObject *AddMapObjectWithLocalID(DistWorldSystem *param0, u32 param1, u16 param2);
static BOOL IsMapObjectManaged(DistWorldSystem *param0, MapObject *param1);
...
static void SetSkyboxStaticDarkness(DistWorldSystem *param0, BOOL param1);
static void SetSkyboxDarkness(DistWorldSystem *param0, s16 param1);
...
static BOOL CheckFlagCondition(DistWorldSystem *param0, enum FlagCondition param1, u32 param2);
...
static void ov9_02249CC4(DistWorldSystem *param0)
{
    ...
    if (!SystemFlag_HandleDistortionWorldPuzzleFinished(v1, HANDLE_FLAG_CHECK)) {
        // clang-format off
        v0->boulderPuzzleFlags |= 1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_BOULDER_IN_B5F |
                                  1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_BOULDER_IN_B5F |
                                  1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_BOULDER_IN_B5F;
        // clang-format on
    } else {
        // clang-format off
        v0->boulderPuzzleFlags |= 1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_TUTO_SEEN |
                                  1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_TUTO_SEEN |
                                  1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_TUTO_SEEN |
                                  1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_BOULDER_IN_B6F_HOLE |
                                  1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_BOULDER_IN_B6F_HOLE |
                                  1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_BOULDER_IN_B6F_HOLE;
        // clang-format on
    }
}
...
static void SetPersistedBoulderPuzzleFlag(DistWorldSystem *system, u32 index)
{
    ...
    GF_ASSERT(index < DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_COUNT);
...
static BOOL CallElevatorPlatformHandler(FieldTask *task)
{
    ...
    return handlerRes == ELEVATOR_PLATFORM_HANDLER_RES_FINISH ? TRUE : FALSE;
}
...
static int DistWorldElevatorPlatform_BeginMovement(DistWorldSystem *system, DistWorldElevatorPlatform *elevatorPlatform)
{
    ...
    if (!elevatorPlatform->vibrationAnimDone) {
        ...
        sub_0206309C(playerMapObj, &mapObjPos);
        elevatorPlatform->initialPlayerY = mapObjPos.y;

        if (elevatorPlatform->passengerMapObj != NULL) {
            sub_0206309C(elevatorPlatform->passengerMapObj, &mapObjPos);
            elevatorPlatform->initialPassengerY = mapObjPos.y;
        }
...
static int DistWorldElevatorPlatform_Vibrate(DistWorldSystem *system, DistWorldElevatorPlatform *elevatorPlatform)
{
    ...
    mapObjPos.y = elevatorPlatform->initialPlayerY + elevatorPlatform->vibrationYDelta;

    sub_020630AC(playerMapObj, &mapObjPos);
    ov9_022511F4(playerMapObj, &elevatorPlatform->playerPos);

    if (elevatorPlatform->passengerMapObj != NULL) {
        sub_0206309C(elevatorPlatform->passengerMapObj, &mapObjPos);
        mapObjPos.y = elevatorPlatform->initialPassengerY + elevatorPlatform->vibrationYDelta;
        sub_020630AC(elevatorPlatform->passengerMapObj, &mapObjPos);
    ...
    if (elevatorPlatform->vibrationYDelta >= 0) {
        ...
        if (elevatorPlatform->vibrationYDelta <= 0) {
            sub_0206309C(playerMapObj, &mapObjPos);
            mapObjPos.y = elevatorPlatform->initialPlayerY;
            sub_020630AC(playerMapObj, &mapObjPos);

            if (elevatorPlatform->passengerMapObj != NULL) {
                sub_0206309C(elevatorPlatform->passengerMapObj, &mapObjPos);
                mapObjPos.y = elevatorPlatform->initialPassengerY;
                sub_020630AC(elevatorPlatform->passengerMapObj, &mapObjPos);
            }
...
static OverworldAnimManager *InitAnimManagerForMovingPlatform(DistWorldSystem *system, DistWorldMovingPlatformPropAnimator *animator)
{
    ...
    return ov5_021DF72C(system->fieldSystem->unk_40, &sMovingPlatformPropAnimFuncs, NULL, 0, &userData, 0);
}
...
static int EventCmdSetMapObjectAnimation_Init(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandSetMapObjectAnimationRunData *runData = ResetRunningEventDataBuffer(system, sizeof(DistWorldEventCommandSetMapObjectAnimationRunData));

    *currCmdState = EVENT_CMD_SET_MAP_OBJECT_ANIMATION_STATE_START;
    return EVENT_CMD_HANDLER_RES_LOOP;
}

static int EventCmdSetMapObjectAnimation_Start(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    const DistWorldEventCommandSetMapObjectAnimationParams *cmdParams = params;
    DistWorldEventCommandSetMapObjectAnimationRunData *runData = GetRunningEventDataBuffer(system);
    ...
    if (LocalMapObj_IsAnimationSet(mapObj) == TRUE) {
        ...
        *currCmdState = EVENT_CMD_SET_MAP_OBJECT_ANIMATION_STATE_FINISH;
    }

    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdSetMapObjectAnimation_Finish(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    const DistWorldEventCommandSetMapObjectAnimationParams *cmdParams = params;
    DistWorldEventCommandSetMapObjectAnimationRunData *runData = GetRunningEventDataBuffer(system);
...
static const DistWorldEventCommandHandler sEventCmdSetMapObjectAnimationHandlers[EVENT_CMD_SET_MAP_OBJECT_ANIMATION_STATE_COUNT] = {
...
static int EventCmdMovePlatform_BeginMovement(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    const DistWorldEventCommandMovePlatformParams *cmdParams = params;
    DistWorldEventCommandMovePlatformRunData *runData = ResetRunningEventDataBuffer(system, sizeof(DistWorldEventCommandMovePlatformRunData));
    ...
    if (cmdParams->movePlayer == TRUE) {
        ...
        runData->initialPlayerY = mapObjPos.y;
    }

    Sound_PlayEffect(SEQ_SE_PL_FW089B);

    *currCmdState = EVENT_CMD_MOVE_PLATFORM_STATE_VIBRATE;
    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdMovePlatform_Vibrate(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    MapObject *playerMapObj = NULL;
    const DistWorldEventCommandMovePlatformParams *cmdParams = params;
    DistWorldEventCommandMovePlatformRunData *runData = GetRunningEventDataBuffer(system);
    VecFx32 *movingPlatformPos = GetMovingPlatformPropPos(runData->animator->animMan);
    ...
    if (playerMapObj != NULL) {
        ...
        sub_0206309C(playerMapObj, &mapObjPos);
        mapObjPos.y = runData->initialPlayerY + runData->vibrationYDelta;

        sub_020630AC(playerMapObj, &mapObjPos);
        MapObject_GetPosPtr(playerMapObj, &mapObjPos);
        ov9_022511F4(playerMapObj, &mapObjPos);
    }
    ...
    if (runData->vibrationYDelta >= 0) {
        ...
        if (runData->vibrationYDelta == 0) {
            ...
            if (playerMapObj != NULL) {
                ...
                sub_0206309C(playerMapObj, &mapObjPos);
                mapObjPos.y = runData->initialPlayerY;
                sub_020630AC(playerMapObj, &mapObjPos);
            ...
            *currCmdState = EVENT_CMD_MOVE_PLATFORM_STATE_MOVE;
        }
    }
...
static int EventCmdMovePlatform_Move(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    ...
    if (cmdParams->movePlayer == TRUE) {
        ...
        mapObjPos.x += posDelta.x;
        mapObjPos.y += posDelta.y;
        mapObjPos.z += posDelta.z;
    ...
    if (runData->currPosOffset.x == runData->finalPosOffset.x && runData->currPosOffset.y == runData->finalPosOffset.y && runData->currPosOffset.z == runData->finalPosOffset.z) {
        *currCmdState = EVENT_CMD_MOVE_PLATFORM_STATE_END;
    }

    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdMovePlatform_EndMovement(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    const DistWorldEventCommandMovePlatformParams *cmdParams = params;
...
static const DistWorldEventCommandHandler sEventCmdMovePlatformHandlers[EVENT_CMD_MOVE_PLATFORM_STATE_COUNT] = {
...
static void LoadGiratinaShadowPropAnimation(DistWorldSystem *system, const DistWorldGiratinaShadowTemplate *giratinaTemplate)
{
    ...
    giratinaRenderer->animMan = ov5_021DF72C(system->fieldSystem->unk_40, &sGiratinaShadowPropAnimFuncs, NULL, 0, &userData, 0);
}

static BOOL IsGiratinaShadowAnimationFinished(DistWorldSystem *system)
{
    DistWorldGiratinaShadowProp *giratinaProp;
    DistWorldGiratinaShadowPropRenderer *giratinaRenderer = &system->giratinaShadowPropRenderer;

    GF_ASSERT(giratinaRenderer->animMan != NULL);

    giratinaProp = OverworldAnimManager_GetFuncsContext(giratinaRenderer->animMan);
...
static BOOL IsGiratinaShadowPropRendererValid2(DistWorldSystem *system, u32 propKind)
{
    ...
    return giratinaRenderer->valid == TRUE && propKind == PROP_KIND_GIRATINA_SHADOW ? TRUE : FALSE;
}
...
static BOOL IsGiratinaShadowPropRendererAnimValid(DistWorldSystem *system, u32 animKind)
{
    ...
    return giratinaRenderer->valid == TRUE && animKind == PROP_ANIM_KIND_GIRATINA_SHADOW ? TRUE : FALSE;
}
...
static const Simple3DRotationAngles sGiratinaShadowPropRotationAngles[5] = {
    { 0x0, 0x0, 0x0 },
    { 0x0, 0xB4, 0x0 },
    { 0x0, 0x5A, 0x0 },
    { 0x0, 0x10E, 0x0 },
...
static BOOL DistWorldGiratinaShadowProp_AnimInit(OverworldAnimManager *animMan, void *context)
{
    ...
    giratinaProp->rotation = sGiratinaShadowPropRotationAngles[template->rotationAnglesIndex];
    ...
    if (template->rotationAnglesIndex == 4) {
        pos.x += FX32_ONE * 8;
    }
...
static void DistWorldGiratinaShadowProp_AnimTick(OverworldAnimManager *animMan, void *context)
{
    ...
    case GIRATINA_SHADOW_PROP_STATE_MOVE: {
        ...
        giratinaProp->currentMovementAnimStep++;

        if (giratinaProp->currentMovementAnimStep >= template->movementAnimSteps) {
            giratinaProp->state++;
...
static void DistWorldGiratinaShadowProp_AnimRender(OverworldAnimManager *animMan, void *context)
{
    ...
    if (!giratinaProp->animStopped) {
        ...
        Simple3D_DrawRenderObjRotationAngles(&giratinaProp->userData.renderer->renderObj, &pos, scale, &giratinaProp->rotation);
    }
}
...
static void InitSimplePropAnimation(DistWorldSystem *system, DistWorldSimplePropAnimator *animator, const DistWorldSimplePropTemplate *simplePropTemplate, u32 mapHeaderID)
{
    ...
    animator->animMan = ov5_021DF72C(system->fieldSystem->unk_40, animFuncs, NULL, 0, &userData, 2);
}
...
static BOOL CheckFlagConditionForObjectEvent(DistWorldSystem *system, const DistWorldObjectEvent *objEvent, BOOL ignoreFlagCondFail)
{
    ...
    if (flagCond == FLAG_COND_NONE_FAIL) {
...
static BOOL AddMapObjectFromEvent(DistWorldSystem *system, MapObject **mapObj, const DistWorldObjectEvent *objEvent, u32 mapHeaderID, u16 ignoreFlagCondFail)
{
    ...
    if (existingMapObj == NULL) {
        ...
        UnkStruct_020216E0 *v1 = ov5_021EB1A0(*mapObj);

        if (v1 != NULL) {
            ov5_021EDEB4(*mapObj, v1);
        }
    }
        ...
        if (mapObjEventsIter->mapHeaderID == mapHeaderID) {
            ...
            while (*objEventIter != NULL) {
                if ((*objEventIter)->objEvent.localID == mapObjLocalID) {
                    ...
                    if (mapHeaderID == MAP_HEADER_DISTORTION_WORLD_B6F && mapObjLocalID >= 0x87 && mapObjLocalID <= 0x8F) {
...
static void ov9_0224F764(DistWorldSystem *param0)
{
    ...
    if (v0->staticDarkness == FALSE) {
        v0->darkness = (v2->y - ((65 << 4) * FX32_ONE)) / ((((289 - 65) << 4) * FX32_ONE) / 12);
    }

    if (v0->darkness < 0) {
        v0->darkness = 0;
    } else if (v0->darkness > 12) {
        v0->darkness = 12;
    }

    if (v0->darkness != v0->unk_02) {
        int v3 = 0;

        do {
            CalculateTintedColor(
                v0->unk_08[v3], (4 | (4 << 5) | (8 << 10)), v0->darkness, &v0->unk_28[v3]);
            v3++;
        } while (v3 < 16);
        ...
        do {
            CalculateTintedColor(
                v0->unk_48[v3], (6 | (6 << 5) | (8 << 10)), v0->darkness, &v0->unk_E8[v3]);
            v3++;
        } while (v3 < (16 * 5));

        v0->unk_04 = 1;
        v0->unk_02 = v0->darkness;
    }
}
...
static void SetSkyboxStaticDarkness(DistWorldSystem *system, BOOL staticDarkness)
{
    UnkStruct_ov9_0224ADC0 *v0 = &system->unk_1D00;
    v0->staticDarkness = staticDarkness;
}

static void SetSkyboxDarkness(DistWorldSystem *system, s16 darkness)
{
    UnkStruct_ov9_0224ADC0 *v0 = &system->unk_1D00;
    v0->darkness = darkness;
}
...
static int EventCmdSetGiratinaAnimationFlag_Handle(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    const DistWorldEventCommandSetGiratinaAnimationFlagParams *cmdParams = params;
    VarsFlags *varsFlags = SaveData_GetVarsFlags(system->fieldSystem->saveData);
...
static const DistWorldEventCommandHandler sEventCmdSetGiratinaAnimationFlagHandlers[1] = {
    EventCmdSetGiratinaAnimationFlag_Handle
};

static int EventCmdSetPersistedBoulderPuzzleFlag_Handle(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    const EventCommandPersistedBoulderPuzzleFlagParams *cmdParams = params;
    SetPersistedBoulderPuzzleFlag(system, cmdParams->flagIndex);

    return EVENT_CMD_HANDLER_RES_FINISH;
}

static const DistWorldEventCommandHandler sEventCmdSetPersistedBoulderPuzzleFlagHandlers[1] = {
    EventCmdSetPersistedBoulderPuzzleFlag_Handle
};

static int EventCmdClearPersistedBoulderPuzzleFlag_Handle(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    const EventCommandPersistedBoulderPuzzleFlagParams *cmdParams = params;
...
static const DistWorldEventCommandHandler sEventCmdClearPersistedBoulderPuzzleFlagHandlers[1] = {
    EventCmdClearPersistedBoulderPuzzleFlag_Handle
};

static int EventCmdShowGiratinaShadow_Load(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    const DistWorldGiratinaShadowTemplate *giratinaTemplate = params;
    LoadGiratinaShadowPropAnimation(system, giratinaTemplate);

    *currCmdState = EVENT_CMD_SHOW_GIRATINA_SHADOW_STATE_FINISH;
    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdShowGiratinaShadow_Finish(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
...
static const DistWorldEventCommandHandler sEventCmdShowGiratinaShadow[EVENT_CMD_SHOW_GIRATINA_SHADOW_STATE_COUNT] = {
...
static void EventCommandPlayGiratinaRoomAppearanceRunData_UpdateSpritePalette(EventCommandPlayGiratinaRoomAppearanceRunData *runData)
{
    u32 currSpriteDarkness = runData->currSpriteDarkness / FX32_ONE;

    for (u32 i = 0; i < PALETTE_SIZE; i++) {
        CalculateTintedColor(sGiratinaSpriteBasePalette[i], GX_RGB(0, 0, 0), currSpriteDarkness, &runData->giratinaSpritePalette[i]);
    }
}
...
void DistWorld_ApplyGiratinaSpritePalette(FieldSystem *fieldSystem)
{
    ...
    if (dwSystem->playingGiratinaRoomAppearance == TRUE) {
        EventCommandPlayGiratinaRoomAppearanceRunData *runData = GetRunningEventDataBuffer(dwSystem);
...
static int EventCmdPlayGiratinaRoomAppearance_InitMapObject(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    EventCommandPlayGiratinaRoomAppearanceRunData *runData = ResetRunningEventDataBuffer(system, sizeof(EventCommandPlayGiratinaRoomAppearanceRunData));
    runData->giratinaMapObj = AddMapObjectWithLocalID(system, MAP_HEADER_DISTORTION_WORLD_GIRATINA_ROOM, 0x80 + 0);
    runData->currGiratinaPosOffset.y = GIRATINA_ROOM_PLAY_APPEARANCE_INITIAL_Y_OFFSET;

    sub_020630AC(runData->giratinaMapObj, &runData->currGiratinaPosOffset);

    *currCmdState = EVENT_CMD_PLAY_GIRATINA_ROOM_APPEARANCE_STATE_INIT_SPRITE_AND_SKYBOX;
    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdPlayGiratinaRoomAppearance_InitSpriteAndSkybox(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    EventCommandPlayGiratinaRoomAppearanceRunData *runData = GetRunningEventDataBuffer(system);
    UnkStruct_020216E0 *v0 = ov5_021EB1A0(runData->giratinaMapObj);

    if (v0 != NULL) {
        runData->currSpriteDarkness = GIRATINA_ROOM_PLAY_APPEARANCE_INITIAL_SPRITE_DARKNESS;
        EventCommandPlayGiratinaRoomAppearanceRunData_UpdateSpritePalette(runData);
        system->playingGiratinaRoomAppearance = TRUE;

        runData->currSkyboxDarkness = SPRITE_MIN_DARKNESS;
        SetSkyboxStaticDarkness(system, TRUE);

        system->unk_1EC2 = 2;
        Sound_PlayEffect(SEQ_SE_PL_GIRA);

        *currCmdState = EVENT_CMD_PLAY_GIRATINA_ROOM_APPEARANCE_STATE_DESCEND;
        return EVENT_CMD_HANDLER_RES_LOOP;
    }
...
static int EventCmdPlayGiratinaRoomAppearance_Descend(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    EventCommandPlayGiratinaRoomAppearanceRunData *runData = GetRunningEventDataBuffer(system);
    runData->currSkyboxDarkness += GIRATINA_ROOM_PLAY_APPEARANCE_SKYBOX_DARKNESS_DELTA;

    if (runData->currSkyboxDarkness >= GIRATINA_ROOM_PLAY_APPEARANCE_SKYBOX_DARKNESS_TARGET) {
        runData->currSkyboxDarkness = GIRATINA_ROOM_PLAY_APPEARANCE_SKYBOX_DARKNESS_TARGET;
    }

    SetSkyboxDarkness(system, runData->currSkyboxDarkness / FX32_ONE);

    if (runData->currGiratinaPosOffset.y >= GIRATINA_ROOM_PLAY_APPEARANCE_DESCEND_Y_SLOW_THRESHOLD) {
        runData->currGiratinaPosOffset.y -= GIRATINA_ROOM_PLAY_APPEARANCE_DESCEND_Y_FAST_DECREMENT;
    } else {
        runData->currGiratinaPosOffset.y -= GIRATINA_ROOM_PLAY_APPEARANCE_DESCEND_Y_SLOW_DECREMENT;
    }

    if (runData->currGiratinaPosOffset.y < 0 && runData->currSkyboxDarkness >= GIRATINA_ROOM_PLAY_APPEARANCE_SKYBOX_DARKNESS_TARGET) {
        runData->currGiratinaPosOffset.y = 0;
        *currCmdState = EVENT_CMD_PLAY_GIRATINA_ROOM_APPEARANCE_STATE_BRIGHTEN_SPRITE;
    }
...
static int EventCmdPlayGiratinaRoomAppearance_BrightenSprite(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    EventCommandPlayGiratinaRoomAppearanceRunData *runData = GetRunningEventDataBuffer(system);
    UnkStruct_020216E0 *v0 = ov5_021EB1A0(runData->giratinaMapObj);
    NNSG3dResMdl *model = sub_02021430(v0);

    runData->currSpriteDarkness -= GIRATINA_ROOM_PLAY_APPEARANCE_SPRITE_DARKNESS_DECREMENT;

    if (runData->currSpriteDarkness < 0) {
        runData->currSpriteDarkness = 0;
        *currCmdState = EVENT_CMD_PLAY_GIRATINA_ROOM_APPEARANCE_STATE_WAIT;
    }
...
static int EventCmdPlayGiratinaRoomAppearance_Wait(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    EventCommandPlayGiratinaRoomAppearanceRunData *runData = GetRunningEventDataBuffer(system);
    runData->currDelay++;

    if (runData->currDelay >= GIRATINA_ROOM_PLAY_APPEARANCE_WAIT_DELAY) {
...
static const DistWorldEventCommandHandler sEventCmdPlayGiratinaRoomAppearanceHandlers[EVENT_CMD_PLAY_GIRATINA_ROOM_APPEARANCE_STATE_COUNT] = {
...
static int EventCmdShowUxieBoulderTuto_Init(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowUxieBoulderTutoRunData *runData = ResetRunningEventDataBuffer(system, sizeof(DistWorldEventCommandShowUxieBoulderTutoRunData));
    runData->uxieMapObj = AddMapObjectWithLocalID(system, MAP_HEADER_DISTORTION_WORLD_B5F, 0x80 + 3);

    Sound_PlayPokemonCry(SPECIES_UXIE, 0);

    runData->currHoverStepDelta = 1;
    *currCmdState = EVENT_CMD_SHOW_UXIE_BOULDER_TUTO_STATE_ASCEND;
    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdShowUxieBoulderTuto_Ascend(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowUxieBoulderTutoRunData *runData;
    fx32 ascendYDelta = UXIE_BOULDER_TUTO_ASCEND_Y_DELTA;

    runData = GetRunningEventDataBuffer(system);

    if ((runData->currUxiePosOffset.y >> 4) / FX32_ONE < UXIE_BOULDER_TUTO_ASCEND_Y_TARGET - 1) {
        ascendYDelta <<= 1;
    }

    runData->currUxiePosOffset.y += ascendYDelta;
    sub_020630AC(runData->uxieMapObj, &runData->currUxiePosOffset);

    if ((runData->currUxiePosOffset.y >> 4) / FX32_ONE >= UXIE_BOULDER_TUTO_ASCEND_Y_TARGET) {
        *currCmdState = EVENT_CMD_SHOW_UXIE_BOULDER_TUTO_STATE_MOVE_TO_BOULDER;
    }

    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdShowUxieBoulderTuto_MoveToBoulder(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowUxieBoulderTutoRunData *runData = GetRunningEventDataBuffer(system);
    runData->currUxiePosOffset.z -= UXIE_BOULDER_TUTO_MOVE_TO_BOULDER_Z_DELTA;
    sub_020630AC(runData->uxieMapObj, &runData->currUxiePosOffset);

    if ((runData->currUxiePosOffset.z >> 4) / FX32_ONE <= UXIE_BOULDER_TUTO_MOVE_TO_BOULDER_Z_TARGET) {
        runData->finalUxieY = runData->currUxiePosOffset.y;
        *currCmdState = EVENT_CMD_SHOW_UXIE_BOULDER_TUTO_STATE_HOVER;
    }

    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdShowUxieBoulderTuto_Hover(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowUxieBoulderTutoRunData *runData;
    fx32 yOffsets[UXIE_BOULDER_TUTO_HOVER_STEP_COUNT] = { 0x0, 0x800, 0x1000, 0x2000, 0x4000, 0x6000, 0x7000, 0x8000 };

    runData = GetRunningEventDataBuffer(system);
    runData->currUxiePosOffset.y = runData->finalUxieY + yOffsets[runData->currHoverStep >> 1];
    sub_020630AC(runData->uxieMapObj, &runData->currUxiePosOffset);

    runData->currHoverStep += runData->currHoverStepDelta;

    if (runData->currHoverStep >= UXIE_BOULDER_TUTO_HOVER_STEP_COUNT * 2 - 1 || runData->currHoverStep <= 0) {
        runData->currHoverStepDelta = -runData->currHoverStepDelta;

        if (runData->currHoverStep == 0) {
            runData->currHoverLoop++;

            if (runData->currHoverLoop >= UXIE_BOULDER_TUTO_HOVER_LOOP_COUNT) {
                runData->currUxiePosOffset.y = runData->finalUxieY + yOffsets[runData->currHoverStep >> 1];
                *currCmdState = EVENT_CMD_SHOW_UXIE_BOULDER_TUTO_STATE_MOVE_AWAY;
            }
        }
    }
...
static int EventCmdShowUxieBoulderTuto_MoveAway(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowUxieBoulderTutoRunData *runData = GetRunningEventDataBuffer(system);
    runData->currUxiePosOffset.z += UXIE_BOULDER_TUTO_MOVE_AWAY_Z_DELTA;

    sub_020630AC(runData->uxieMapObj, &runData->currUxiePosOffset);

    if ((runData->currUxiePosOffset.z >> 4) / FX32_ONE == UXIE_BOULDER_TUTO_MOVE_AWAY_Z_TARGET) {
        *currCmdState = EVENT_CMD_SHOW_UXIE_BOULDER_TUTO_STATE_DESCEND;
    }

    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdShowUxieBoulderTuto_Descend(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowUxieBoulderTutoRunData *runData = GetRunningEventDataBuffer(system);

    if (runData->currDescendYDelta < UXIE_BOULDER_TUTO_DESCEND_Y_DELTA_TARGET) {
        runData->currDescendYDelta += UXIE_BOULDER_TUTO_DESCEND_Y_DELTA_INCREMENT;
    }

    runData->currUxiePosOffset.y -= runData->currDescendYDelta;
    sub_020630AC(runData->uxieMapObj, &runData->currUxiePosOffset);

    if ((runData->currUxiePosOffset.y >> 4) / FX32_ONE <= 0) {
        DeleteMapObject(system, runData->uxieMapObj);
        SetPersistedBoulderPuzzleFlag(system, DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_TUTO_SEEN);
        SetPersistedBoulderPuzzleFlag(system, DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_IN_B6F);
        runData->uxieMapObj = AddMapObjectWithLocalID(system, MAP_HEADER_DISTORTION_WORLD_B6F, 0x80 + 4);
...
static const DistWorldEventCommandHandler sEventCmdShowUxieBoulderTutoHandlers[EVENT_CMD_SHOW_UXIE_BOULDER_TUTO_STATE_COUNT] = {
...
static int EventCmdShowAzelfBoulderTuto_Init(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowAzelfBoulderTutoRunData *runData = ResetRunningEventDataBuffer(system, sizeof(DistWorldEventCommandShowAzelfBoulderTutoRunData));
    runData->azelfMapObj = AddMapObjectWithLocalID(system, MAP_HEADER_DISTORTION_WORLD_B5F, 0x80 + 4);

    Sound_PlayPokemonCry(SPECIES_AZELF, 0);

    *currCmdState = EVENT_CMD_SHOW_AZELF_BOULDER_TUTO_STATE_ASCEND;
    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdShowAzelfBoulderTuto_Ascend(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowAzelfBoulderTutoRunData *runData;
    fx32 ascendYDelta = AZELF_BOULDER_TUTO_ASCEND_Y_DELTA;

    runData = GetRunningEventDataBuffer(system);

    if ((runData->currAzelfPosOffset.y >> 4) / FX32_ONE < AZELF_BOULDER_TUTO_ASCEND_Y_TARGET - 1) {
        ascendYDelta <<= 1;
    }

    runData->currAzelfPosOffset.y += ascendYDelta;
    sub_020630AC(runData->azelfMapObj, &runData->currAzelfPosOffset);

    if ((runData->currAzelfPosOffset.y >> 4) / FX32_ONE >= AZELF_BOULDER_TUTO_ASCEND_Y_TARGET) {
        runData->azelfAnimTask = MapObject_StartAnimation(runData->azelfMapObj, sAzelfBoulderTutoAnimation);
        *currCmdState = EVENT_CMD_SHOW_AZELF_BOULDER_TUTO_STATE_WAIT_FOR_ANIMATION;
    }

    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdShowAzelfBoulderTuto_WaitForAnimation(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowAzelfBoulderTutoRunData *runData = GetRunningEventDataBuffer(system);

    if (MapObject_HasAnimationEnded(runData->azelfAnimTask) == TRUE) {
        MapObject_FinishAnimation(runData->azelfAnimTask);

        *currCmdState = EVENT_CMD_SHOW_AZELF_BOULDER_TUTO_STATE_DESCEND;
        return EVENT_CMD_HANDLER_RES_LOOP;
    }
...
static int EventCmdShowAzelfBoulderTuto_Descend(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowAzelfBoulderTutoRunData *runData = GetRunningEventDataBuffer(system);

    if (runData->currDescendYDelta < AZELF_BOULDER_TUTO_DESCEND_Y_DELTA_TARGET) {
        runData->currDescendYDelta += AZELF_BOULDER_TUTO_DESCEND_Y_DELTA_INCREMENT;
    }

    runData->currAzelfPosOffset.y -= runData->currDescendYDelta;
    sub_020630AC(runData->azelfMapObj, &runData->currAzelfPosOffset);

    if ((runData->currAzelfPosOffset.y >> 4) / FX32_ONE <= 0) {
        DeleteMapObject(system, runData->azelfMapObj);
        SetPersistedBoulderPuzzleFlag(system, DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_TUTO_SEEN);
        SetPersistedBoulderPuzzleFlag(system, DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_IN_B6F);
        runData->azelfMapObj = AddMapObjectWithLocalID(system, MAP_HEADER_DISTORTION_WORLD_B6F, 0x80 + 5);
...
static const DistWorldEventCommandHandler sEventCmdShowAzelfBoulderTutoHandlers[EVENT_CMD_SHOW_AZELF_BOULDER_TUTO_STATE_COUNT] = {
...
static int EventCmdShowMespritBoulderTuto_Init(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowMespritBoulderTutoRunData *runData = ResetRunningEventDataBuffer(system, sizeof(DistWorldEventCommandShowAzelfBoulderTutoRunData));
    runData->mespritMapObj = AddMapObjectWithLocalID(system, MAP_HEADER_DISTORTION_WORLD_B5F, 0x80 + 5);

    Sound_PlayPokemonCry(SPECIES_MESPRIT, 0);

    *currCmdState = EVENT_CMD_SHOW_MESPRIT_BOULDER_TUTO_STATE_ASCEND;
    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdShowMespritBoulderTuto_Ascend(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowMespritBoulderTutoRunData *runData;
    fx32 ascendYDelta = MESPRIT_BOULDER_TUTO_ASCEND_Y_DELTA;

    runData = GetRunningEventDataBuffer(system);

    if ((runData->currMespritPosOffset.y >> 4) / FX32_ONE < MESPRIT_BOULDER_TUTO_ASCEND_Y_TARGET - 1) {
        ascendYDelta <<= 1;
    }

    runData->currMespritPosOffset.y += ascendYDelta;
    sub_020630AC(runData->mespritMapObj, &runData->currMespritPosOffset);

    if ((runData->currMespritPosOffset.y >> 4) / FX32_ONE >= MESPRIT_BOULDER_TUTO_ASCEND_Y_TARGET) {
        ...
        *currCmdState = EVENT_CMD_SHOW_MESPRIT_BOULDER_TUTO_STATE_WAIT_FOR_ANIMATION;
    }

    return EVENT_CMD_HANDLER_RES_CONTINUE;
}

static int EventCmdShowMespritBoulderTuto_WaitForAnimation(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowMespritBoulderTutoRunData *runData = GetRunningEventDataBuffer(system);
    ...
    if (MapObject_HasAnimationEnded(runData->mespritAnimTask) == TRUE && MapObject_HasAnimationEnded(runData->playerAnimTask) == TRUE) {
        ...
        *currCmdState = EVENT_CMD_SHOW_MESPRIT_BOULDER_TUTO_STATE_DESCEND;
        return EVENT_CMD_HANDLER_RES_LOOP;
    }
...
static int EventCmdShowMespritBoulderTuto_Descend(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    DistWorldEventCommandShowMespritBoulderTutoRunData *runData = GetRunningEventDataBuffer(system);

    if (runData->currDescendYDelta < MESPRIT_BOULDER_TUTO_DESCEND_Y_DELTA_TARGET) {
        runData->currDescendYDelta += MESPRIT_BOULDER_TUTO_DESCEND_Y_DELTA_INCREMENT;
    }

    runData->currMespritPosOffset.y -= runData->currDescendYDelta;
    sub_020630AC(runData->mespritMapObj, &runData->currMespritPosOffset);

    if ((runData->currMespritPosOffset.y >> 4) / FX32_ONE <= 0) {
        DeleteMapObject(system, runData->mespritMapObj);
        SetPersistedBoulderPuzzleFlag(system, DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_TUTO_SEEN);
        SetPersistedBoulderPuzzleFlag(system, DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_IN_B6F);
        runData->mespritMapObj = AddMapObjectWithLocalID(system, MAP_HEADER_DISTORTION_WORLD_B6F, 0x80 + 3);
...
static const DistWorldEventCommandHandler sEventCmdShowMespritBoulderTutoHandlers[EVENT_CMD_SHOW_MESPRIT_BOULDER_TUTO_STATE_COUNT] = {
...
static int EventCmdShowGiratinaRoomPlatforms_DoCameraTransition(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    EventCommandShowGiratinaRoomPlatformsRunData *runData = ResetRunningEventDataBuffer(system, sizeof(EventCommandShowGiratinaRoomPlatformsRunData));

    DoCameraTransition(system, &sGiratinaRoomPlatformsShownCameraAngle);

    runData->currDelay = GIRATINA_ROOM_SHOW_PLATFORMS_INITIAL_DELAY;
    runData->currGhostPropGroup = GIRATINA_ROOM_PLATFORMS_FIRST_GHOST_PROP_GROUP;
    *currCmdState = EVENT_CMD_SHOW_GIRATINA_ROOM_PLATFORMS_STATE_SHOW_PLATFORMS;

    return EVENT_CMD_HANDLER_RES_LOOP;
}

static int EventCmdShowGiratinaRoomPlatforms_ShowPlatforms(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    EventCommandShowGiratinaRoomPlatformsRunData *runData = GetRunningEventDataBuffer(system);

    runData->currDelay--;

    if (runData->currDelay <= 0) {
        runData->currDelay = GIRATINA_ROOM_SHOW_PLATFORMS_DELAY;
        Sound_StopEffect(SEQ_SE_PL_SYUWA3, 0);
        ShowGhostPropGroup(system, runData->currGhostPropGroup);
        runData->currGhostPropGroup++;

        if (runData->currGhostPropGroup >= GIRATINA_ROOM_PLATFORMS_LAST_GHOST_PROP_GROUP + 1) {
            return EVENT_CMD_HANDLER_RES_FINISH;
        }
    }
...
static const DistWorldEventCommandHandler sEventCmdShowGiratinaRoomPlatformsHandlers[EVENT_CMD_SHOW_GIRATINA_ROOM_PLATFORMS_COUNT] = {
...
static int EventCmdHideGiratinaRoomPlatforms_Init(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    EventCommandHideGiratinaRoomPlatformsRunData *runData = ResetRunningEventDataBuffer(system, sizeof(EventCommandHideGiratinaRoomPlatformsRunData));
    runData->currDelay = GIRATINA_ROOM_HIDE_PLATFORMS_INITIAL_DELAY;
    runData->currGhostPropGroup = GIRATINA_ROOM_PLATFORMS_LAST_GHOST_PROP_GROUP;

    *currCmdState = EVENT_CMD_HIDE_GIRATINA_ROOM_PLATFORMS_STATE_HIDE_PLATFORMS;
    return EVENT_CMD_HANDLER_RES_LOOP;
}

static int EventCmdHideGiratinaRoomPlatforms_HidePlatforms(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    EventCommandHideGiratinaRoomPlatformsRunData *runData = GetRunningEventDataBuffer(system);

    runData->currDelay--;

    if (runData->currDelay <= 0) {
        if (runData->currGhostPropGroup >= GIRATINA_ROOM_PLATFORMS_FIRST_GHOST_PROP_GROUP) {
            runData->currDelay = GIRATINA_ROOM_HIDE_PLATFORMS_DELAY;
            Sound_StopEffect(SEQ_SE_PL_SYUWA3, 0);
            HideGhostPropGroup(system, runData->currGhostPropGroup);
            runData->currGhostPropGroup--;
        } else {
            runData->currDelay = GIRATINA_ROOM_HIDE_PLATFORMS_WAIT_DELAY;
            *currCmdState = EVENT_CMD_HIDE_GIRATINA_ROOM_PLATFORMS_STATE_WAIT;
        }
    }
...
static int EventCmdHideGiratinaRoomPlatforms_Wait(DistWorldSystem *system, FieldTask *task, u16 *currCmdState, const void *params)
{
    EventCommandHideGiratinaRoomPlatformsRunData *runData = GetRunningEventDataBuffer(system);
...
static const DistWorldEventCommandHandler sEventCmdHideGiratinaRoomPlatformsHandlers[EVENT_CMD_HIDE_GIRATINA_ROOM_PLATFORMS_COUNT] = {
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_1_1 = {
    .platformIndex = 0x1,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_1_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_NORTH
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_1_3 = {
    .platformIndex = 0x1,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_2_1 = {
    .platformIndex = 0x1,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_2_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_SOUTH
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_2_3 = {
    .platformIndex = 0x1,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_3_1 = {
    .platformIndex = 0x2,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_3_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_NORTH
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_3_3 = {
    .platformIndex = 0x2,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_4_1 = {
    .platformIndex = 0x2,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_4_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_SOUTH
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_4_3 = {
    .platformIndex = 0x2,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_5_1 = {
    .platformIndex = 0x3,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_5_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_5_3 = {
    .platformIndex = 0x3,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_6_1 = {
    .platformIndex = 0x3,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_6_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_6_3 = {
    .platformIndex = 0x3,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_7_1 = {
    .platformIndex = 0x5,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_7_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_SOUTH
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_7_3 = {
    .platformIndex = 0x5,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_8_1 = {
    .platformIndex = 0x5,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_8_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_NORTH
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_8_3 = {
    .platformIndex = 0x5,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_9_1 = {
    .platformIndex = 0x6,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_9_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_9_3 = {
    .platformIndex = 0x6,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_10_1 = {
    .platformIndex = 0x6,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_10_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_10_3 = {
    .platformIndex = 0x6,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_11_1 = {
    .platformIndex = 0x9,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_11_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_11_3 = {
    .platformIndex = 0x9,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_12_1 = {
    .platformIndex = 0x9,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_12_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_12_3 = {
    .platformIndex = 0x9,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_13_1 = {
    .platformIndex = 0xA,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_13_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_13_3 = {
    .platformIndex = 0xA,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_14_1 = {
    .platformIndex = 0xA,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_14_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_14_3 = {
    .platformIndex = 0xA,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_15_1 = {
    .platformIndex = 0xB,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_15_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_SOUTH
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_15_3 = {
    .platformIndex = 0xB,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_16_1 = {
    .platformIndex = 0xB,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_16_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_NORTH
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_16_3 = {
    .platformIndex = 0xB,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_17_1 = {
    .platformIndex = 0xC,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_17_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_17_3 = {
    .platformIndex = 0xC,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_18_1 = {
    .platformIndex = 0xC,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_18_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_18_3 = {
    .platformIndex = 0xC,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_19_1 = {
    .platformIndex = 0xD,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_19_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_19_3 = {
    .platformIndex = 0xD,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x11,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_20_1 = {
    .platformIndex = 0xD,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x11,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_20_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_20_3 = {
    .platformIndex = 0xD,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x11,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_21_1 = {
    .platformIndex = 0x11,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_21_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_NORTH
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_21_3 = {
    .platformIndex = 0x11,
    .movePlayer = FALSE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_22_1 = {
    .platformIndex = 0x11,
    .movePlayer = FALSE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_22_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_SOUTH
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_22_3 = {
    .platformIndex = 0x11,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_23_1 = {
    .platformIndex = 0x10,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_23_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_23_3 = {
    .platformIndex = 0x10,
    .movePlayer = FALSE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_24_1 = {
    .platformIndex = 0x10,
    .movePlayer = FALSE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCommandSetMapObjectAnimationParams sMapEventCmdParamsB2F_24_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCommandMovePlatformParams sMapEventCmdParamsB2F_24_3 = {
    .platformIndex = 0x10,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldGiratinaShadowTemplate sMapEventCmdParamsB4F_1_1 = {
    ...
    .initialTileY = 0xA9,
    .initialTileZ = 0x9,
    .rotationAnglesIndex = 0x1,
    .soundKind = GIRATINA_SHADOW_PROP_SFX_KIND_CRY,
    .scale = { FX32_ONE, FX32_ONE, FX32_ONE },
    .posDelta = { 0x0, 0x0, (FX32_ONE * 48) },
    .movementAnimSteps = 0x40,
};

static const DistWorldEventCommandSetGiratinaAnimationFlagParams sMapEventCmdParamsB4F_1_2 = {
    .anim = GIRATINA_SHADOW_ANIM_LEFT_TO_RIGHT
};

static const DistWorldEventCommand sMapEventB4F_1[] = {
    { .kind = EVENT_CMD_KIND_SHOW_GIRATINA_SHADOW,
        .params = &sMapEventCmdParamsB4F_1_1 },
    { .kind = EVENT_CMD_KIND_SET_GIRATINA_ANIMATION_FLAG,
...
static const DistWorldEventCommandSetGiratinaAnimationFlagParams sMapEventCmdParamsB4F_2_2 = {
    .anim = GIRATINA_SHADOW_ANIM_BOTTOM_TO_TOP
};
...
static const DistWorldEventCommand sMapEventB5F_1[] = {
    { .kind = EVENT_CMD_KIND_SHOW_UXIE_BOULDER_TUTO,
        .params = NULL },
    { EVENT_CMD_KIND_INVALID, NULL }
};

static const DistWorldEventCommand sMapEventB5F_2[] = {
    { .kind = EVENT_CMD_KIND_SHOW_AZELF_BOULDER_TUTO,
        .params = NULL },
    { EVENT_CMD_KIND_INVALID, NULL }
};

static const DistWorldEventCommand sMapEventB5F_3[] = {
    { .kind = EVENT_CMD_KIND_SHOW_MESPRIT_BOULDER_TUTO,
        .params = NULL },
    { EVENT_CMD_KIND_INVALID, NULL }
};
...
static const DistWorldEvent sMapEventsB5F[] = {
    { .tileX = 0x56,
        ...
        .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_TUTO_SEEN,
        .cmds = sMapEventB5F_1 },
    { .tileX = 0x57,
        .tileY = 0x81,
        .tileZ = 0x35,
    ...
    { .tileX = 0x64,
        ...
        .tileZ = 0x43,
        .flagCond = FLAG_COND_BOULDER_PUZZLE_FALSE,
        .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_TUTO_SEEN,
        .cmds = sMapEventB5F_2 },
    { .tileX = 0x64,
        .tileY = 0x81,
        .tileZ = 0x44,
    ...
    { .tileX = 0x50,
        ...
        .tileZ = 0x43,
        .flagCond = FLAG_COND_BOULDER_PUZZLE_FALSE,
        .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_TUTO_SEEN,
        .cmds = sMapEventB5F_3 },
    { .tileX = 0x50,
        .tileY = 0x81,
        .tileZ = 0x44,
...
static const EventCommandPersistedBoulderPuzzleFlagParams sMapEventCmdParamsGiratinaRoom_1_1 = {
...
static const EventCommandPersistedBoulderPuzzleFlagParams sMapEventCmdParamsGiratinaRoom_2_1 = {
    .flagIndex = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_GIRATINA_ROOM_PLATFORMS_VISIBLE
};
...
static const DistWorldEvent sMapEventsGiratinaRoom[] = {
    { .tileX = 0xF,
        ...
        .tileZ = 0x17,
        .flagCond = FLAG_COND_BOULDER_PUZZLE_FALSE,
        .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_GIRATINA_ROOM_PLATFORMS_VISIBLE,
...
static const DistWorldSimplePropTemplate sSimpleProps1F[] = {
    { .dummy00 = 0x0,
        ...
        .flagCond = FLAG_COND_NONE,
        .flagCondVal = 0x0 },
    { 0x0, PROP_KIND_INVALID, 0x0, FLAG_COND_NONE, 0x0 }
};
...
static const DistWorldSimplePropTemplate sSimplePropsB5F[] = {
    { .dummy00 = 0x0,
        ...
        .flagCond = FLAG_COND_NONE,
        .flagCondVal = 0x0 },
    { 0x0, PROP_KIND_INVALID, 0x0, 0x0, 0x0, FLAG_COND_NONE, 0x0 }
};
...
static const DistWorldObjectEvent sMapObjectEvent1F_1 = {
    .flagCond = FLAG_COND_NONE_FAIL,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
...
static const DistWorldObjectEvent sMapObjectEvent1F_2 = {
...
static const DistWorldObjectEvent sMapObjectEventB1F_1 = {
    .flagCond = FLAG_COND_NONE_FAIL,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent *sMapObjectEventsB1F[] = {
    &sMapObjectEventB1F_1,
    NULL
};

static const DistWorldObjectEvent sMapObjectEventB2F_1 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_EQ,
    .flagCondVal = 0x4,
    .rotated = TRUE,
    .rotationAngle = 0x5A,
...
static const DistWorldObjectEvent sMapObjectEventB2F_2 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_EQ,
    .flagCondVal = 0x5,
    .rotated = TRUE,
    .rotationAngle = 0x5A,
...
static const DistWorldObjectEvent *sMapObjectEventsB2F[] = {
    &sMapObjectEventB2F_1,
    &sMapObjectEventB2F_2,
    NULL
};

static const DistWorldObjectEvent sMapObjectEventB3F_1 = {
    .flagCond = FLAG_COND_NONE_FAIL,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent *sMapObjectEventsB3F[] = {
    &sMapObjectEventB3F_1,
    NULL
};

static const DistWorldObjectEvent sMapObjectEventB4F_1 = {
...
static const DistWorldObjectEvent *sMapObjectEventsB4F[] = {
    &sMapObjectEventB4F_1,
    NULL
};

static const DistWorldObjectEvent sMapObjectEventB5F_1 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_BOULDER_IN_B5F,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x80,
...
static const DistWorldObjectEvent sMapObjectEventB5F_2 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_BOULDER_IN_B5F,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x81,
...
static const DistWorldObjectEvent sMapObjectEventB5F_3 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_BOULDER_IN_B5F,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x82,
...
static const DistWorldObjectEvent sMapObjectEventB5F_4 = {
    .flagCond = FLAG_COND_NONE_FAIL,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB5F_5 = {
    .flagCond = FLAG_COND_NONE_FAIL,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB5F_6 = {
    .flagCond = FLAG_COND_NONE_FAIL,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent *sMapObjectEventsB5F[] = {
    &sMapObjectEventB5F_1,
    &sMapObjectEventB5F_2,
    &sMapObjectEventB5F_3,
    &sMapObjectEventB5F_4,
    &sMapObjectEventB5F_5,
    &sMapObjectEventB5F_6,
    NULL
};

static const DistWorldObjectEvent sMapObjectEventB6F_1 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_BOULDER_IN_B6F_OUTSIDE,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x80,
...
static const DistWorldObjectEvent sMapObjectEventB6F_2 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_BOULDER_IN_B6F_OUTSIDE,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x81,
...
static const DistWorldObjectEvent sMapObjectEventB6F_3 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_BOULDER_IN_B6F_OUTSIDE,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x82,
...
static const DistWorldObjectEvent sMapObjectEventB6F_4 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_IN_B6F,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x83,
...
static const DistWorldObjectEvent sMapObjectEventB6F_5 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_IN_B6F,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x84,
...
static const DistWorldObjectEvent sMapObjectEventB6F_6 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_IN_B6F,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x85,
...
static const DistWorldObjectEvent sMapObjectEventB6F_7 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_EQ,
    .flagCondVal = 0x6,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB6F_8 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_EQ,
    .flagCondVal = 0x7,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB6F_9 = {
    .flagCond = FLAG_COND_NONE,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB6F_10 = {
    .flagCond = FLAG_COND_NONE,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB6F_11 = {
    .flagCond = FLAG_COND_NONE,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB6F_12 = {
    .flagCond = FLAG_COND_NONE,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB6F_13 = {
    .flagCond = FLAG_COND_NONE,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB6F_14 = {
    .flagCond = FLAG_COND_NONE,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB6F_15 = {
    .flagCond = FLAG_COND_NONE,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB6F_16 = {
    .flagCond = FLAG_COND_NONE,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB6F_17 = {
    .flagCond = FLAG_COND_NONE,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB6F_18 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_BOULDER_IN_B6F_HOLE,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x90,
...
static const DistWorldObjectEvent sMapObjectEventB6F_19 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_BOULDER_IN_B6F_HOLE,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x91,
...
static const DistWorldObjectEvent sMapObjectEventB6F_20 = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_BOULDER_IN_B6F_HOLE,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
        .localID = 0x92,
...
static const DistWorldObjectEvent *sMapObjectEventsB6F[] = {
    &sMapObjectEventB6F_1,
    &sMapObjectEventB6F_2,
    &sMapObjectEventB6F_3,
    &sMapObjectEventB6F_4,
    &sMapObjectEventB6F_5,
    &sMapObjectEventB6F_6,
    &sMapObjectEventB6F_7,
    &sMapObjectEventB6F_8,
    &sMapObjectEventB6F_9,
    &sMapObjectEventB6F_10,
    &sMapObjectEventB6F_11,
    &sMapObjectEventB6F_12,
    &sMapObjectEventB6F_13,
    &sMapObjectEventB6F_14,
    &sMapObjectEventB6F_15,
    &sMapObjectEventB6F_16,
    &sMapObjectEventB6F_17,
    &sMapObjectEventB6F_18,
    &sMapObjectEventB6F_19,
    &sMapObjectEventB6F_20,
    NULL
};

static const DistWorldObjectEvent sMapObjectEventB7F_1 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_EQ,
    .flagCondVal = 0x8,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB7F_2 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_EQ,
    .flagCondVal = 0x9,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB7F_3 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_GEQ,
    .flagCondVal = 0xA,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB7F_4 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_LEQ,
    .flagCondVal = 0x8,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventB7F_5 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_EQ,
    .flagCondVal = 0x9,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent *sMapObjectEventsB7F[] = {
    &sMapObjectEventB7F_1,
    &sMapObjectEventB7F_2,
    &sMapObjectEventB7F_3,
    &sMapObjectEventB7F_4,
    &sMapObjectEventB7F_5,
    NULL
};

static const DistWorldObjectEvent sMapObjectEventGiratinaRoom_1 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_EQ,
    .flagCondVal = 0xD,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventGiratinaRoom_2 = {
    .flagCond = FLAG_COND_NONE_FAIL,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventGiratinaRoom_3 = {
    .flagCond = FLAG_COND_NONE_FAIL,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventGiratinaRoom_4 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_EQ,
    .flagCondVal = 0xE,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventGiratinaRoom_5 = {
    .flagCond = FLAG_COND_WORLD_PROGRESS_EQ,
    .flagCondVal = 0xE,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent *sMapObjectEventsGiratinaRoom[] = {
    &sMapObjectEventGiratinaRoom_1,
    &sMapObjectEventGiratinaRoom_2,
    &sMapObjectEventGiratinaRoom_3,
    &sMapObjectEventGiratinaRoom_4,
    &sMapObjectEventGiratinaRoom_5,
    NULL
};

static const DistWorldObjectEvent sMapObjectEventTurnbackCaveRoom_1 = {
    .flagCond = FLAG_COND_NONE,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent sMapObjectEventTurnbackCaveRoom_2 = {
    .flagCond = FLAG_COND_NONE,
    .flagCondVal = 0x0,
    .rotated = FALSE,
    .rotationAngle = 0x0,
...
static const DistWorldObjectEvent *sMapObjectEventsTurnbackCaveRoom[] = {
    &sMapObjectEventTurnbackCaveRoom_1,
    &sMapObjectEventTurnbackCaveRoom_2,
    NULL
};
