...
typedef struct {
    ...
    s16 playerDirection;
    s32 transitionSteps;
} DistortionWorldCameraAngleConfiguration;
...
typedef struct {
    int cameraAngleConfigCount;
    DistortionWorldCameraAngleConfiguration *cameraAngleConfigs;
} DistortionWorldCameraAngleConfigurationList;
...
typedef struct {
    int count;
    DistortionWorldCameraAngleConfiguration *configs;
...
typedef struct {
    ...
    DistortionWorldCameraAngleConfigurationList cameraAngleConfigList;
...
static void DistortionWorld_OpenArchives(DistortionWorldSystem *param0);
static void DistortionWorld_CloseArchives(DistortionWorldSystem *param0);
static void ov9_02249CC4(DistortionWorldSystem *param0);
static void DistortionWorld_SetPersistedCameraAngles(DistortionWorldSystem *param0, u16 param1, u16 param2, u16 param3);
static void DistortionWorld_GetPersistedCameraAngles(DistortionWorldSystem *param0, u16 *param1, u16 *param2, u16 *param3);
static BOOL DistortionWorld_IsPersistedDataValid(DistortionWorldSystem *param0);
...
static void DistortionWorld_CameraInit(DistortionWorldSystem *param0);
static void DistortionWorld_CameraFree(DistortionWorldSystem *param0);
static void DistortionWorld_CameraTransitionTask(SysTask *param0, void *param1);
static BOOL DistortionWorld_DoCameraTransition(DistortionWorldSystem *param0, const DistortionWorldCameraAngleConfiguration *param1);
...
static BOOL DistortionWorld_ApplyCorrectCameraAngleForPlayer(DistortionWorldSystem *param0, int param1, int param2, int param3, int param4);
...
static u32 DistortionWorldFile_GetNARCIndex(DistortionWorldSystem *param0, int param1);
...
static void DistortionWorldFile_Load(DistortionWorldSystem *param0, DistortionWorldFile *param1, int param2);
...
static void DistortionWorldFile_Free(DistortionWorldFile *param0);
...
static int DistortionWorldFile_GetCameraAngleSectionSize(DistortionWorldFile *param0);
static int DistortionWorldFile_GetCameraAngleCount(DistortionWorldFile *param0);
static DistortionWorldCameraAngleConfiguration *DistortionWorldFile_GetCameraAngleConfigs(DistortionWorldFile *param0);
...
static void DistortionWorld_InitCameraAngleConfigList(DistortionWorldSystem *param0);
static void DistortionWorld_ResetCameraAngleConfigList(DistortionWorldSystem *param0);
static const DistortionWorldCameraAngleConfiguration *DistortionWorld_FindCorrectCameraAngleForPlayer(DistortionWorldSystem *param0, int param1, int param2, int param3, int param4);
...
static BOOL DistortionWorldBounds_AreCoordinatesInBounds(int param0, int param1, int param2, const DistortionWorldBounds *param3);
static int DistortionWorld_CalculateCameraAngleDelta(u16 param0, u16 param1);
static void ov9_02250EE8(s16 *param0, s16 param1);
static void ov9_02250F1C(fx32 *param0, fx32 param1);
static void DistortionWorld_GetPlayerPos(DistortionWorldSystem *param0, int *param1, int *param2, int *param3);
static u32 DistortionWorld_GetMapHeaderID(DistortionWorldSystem *param0);
...
static BOOL DistortionWorld_DoCameraTransition(DistortionWorldSystem *distortionWorldSystem, const DistortionWorldCameraAngleConfiguration *cameraAngleConfig)
{
    DistortionWorldCameraManager *cameraMan = &distortionWorldSystem->cameraMan;
    DistortionWorldCameraTransition *transition = &cameraMan->transition;

    DistortionWorld_SetPersistedCameraAngles(distortionWorldSystem, cameraAngleConfig->angleX, cameraAngleConfig->angleY, cameraAngleConfig->angleZ);

    cameraMan->targetAngle.x = cameraAngleConfig->angleX * DISTORTION_WORLD_CAMERA_PERSISTED_ANGLES_FACTOR;
    cameraMan->targetAngle.y = cameraAngleConfig->angleY * DISTORTION_WORLD_CAMERA_PERSISTED_ANGLES_FACTOR;
    cameraMan->targetAngle.z = cameraAngleConfig->angleZ * DISTORTION_WORLD_CAMERA_PERSISTED_ANGLES_FACTOR;
    ...
    transition->stepsLeft = cameraAngleConfig->transitionSteps;
    ...
    transition->angleStep.x = (FX32_ONE * angleDelta) / cameraAngleConfig->transitionSteps;

    angleDelta = DistortionWorld_CalculateCameraAngleDelta(cameraMan->currentAngle.y, cameraMan->targetAngle.y);
    transition->angleStep.y = (FX32_ONE * angleDelta) / cameraAngleConfig->transitionSteps;

    angleDelta = DistortionWorld_CalculateCameraAngleDelta(cameraMan->currentAngle.z, cameraMan->targetAngle.z);
    transition->angleStep.z = (FX32_ONE * angleDelta) / cameraAngleConfig->transitionSteps;
...
{
    const DistortionWorldCameraAngleConfiguration *cameraAngleConfig = DistortionWorld_FindCorrectCameraAngleForPlayer(distortionWorldSystem, playerX, playerY, playerZ, playerDir);

    if (cameraAngleConfig == NULL) {
        return FALSE;
    }

    DistortionWorld_DoCameraTransition(distortionWorldSystem, cameraAngleConfig);
    return TRUE;
}
...
static void ov9_0224BE14(DistortionWorldSystem *param0)
{
    ...
    ov9_0224C2C4(param0);
    ov9_0224C640(param0);
    DistortionWorld_InitCameraAngleConfigList(param0);
    ov9_0224C808(param0);
...
static void ov9_0224BE8C(DistortionWorldSystem *param0)
{
    DistortionWorld_ResetCameraAngleConfigList(param0);
    ov9_0224C680(param0);
    ov9_0224C300(param0);
    ov9_0224C854(param0);
    ov9_0224C164(param0);
...
static u32 DistortionWorldFile_GetNARCIndex(DistortionWorldSystem *distortionWorldSystem, int mapHeaderID)
{
...
static void DistortionWorldFile_Load(DistortionWorldSystem *distortionWorldSystem, DistortionWorldFile *file, int mapHeaderID)
{
    ...
    if (mapHeaderID != MAP_HEADER_COUNT) {
        ...
        narcIndex = DistortionWorldFile_GetNARCIndex(distortionWorldSystem, mapHeaderID);
...
static DistortionWorldCameraAngleConfiguration *DistortionWorldFile_GetCameraAngleConfigs(DistortionWorldFile *file)
{
    u8 *cameraAngleConfigs = (u8 *)file->cameraAngleSection;
    cameraAngleConfigs += sizeof(int);

    return (DistortionWorldCameraAngleConfiguration *)cameraAngleConfigs;
}
...
static void DistortionWorld_InitCameraAngleConfigList(DistortionWorldSystem *distortionWorldSystem)
{
    DistortionWorldFile *file = &distortionWorldSystem->unk_169C.distortionWorldFile;

    GF_ASSERT(distortionWorldSystem->unk_169C.cameraAngleConfigList.cameraAngleConfigs == NULL);

    if (DistortionWorldFile_GetCameraAngleSectionSize(file)) {
        DistortionWorldCameraAngleConfigurationList *cameraAngleConfigList = &distortionWorldSystem->unk_169C.cameraAngleConfigList;

        cameraAngleConfigList->cameraAngleConfigCount = DistortionWorldFile_GetCameraAngleCount(file);
        cameraAngleConfigList->cameraAngleConfigs = DistortionWorldFile_GetCameraAngleConfigs(file);
    }
}

static void DistortionWorld_ResetCameraAngleConfigList(DistortionWorldSystem *distortionWorldSystem)
{
    DistortionWorldCameraAngleConfigurationList *cameraAngleConfigList = &distortionWorldSystem->unk_169C.cameraAngleConfigList;
    memset(cameraAngleConfigList, 0, sizeof(DistortionWorldCameraAngleConfigurationList));
}

static const DistortionWorldCameraAngleConfiguration *DistortionWorld_FindCorrectCameraAngleForPlayer(DistortionWorldSystem *distortionWorldSystem, int playerX, int playerY, int playerZ, int playerDir)
{
    DistortionWorldCameraAngleConfigurationList *cameraAngleConfigList = &distortionWorldSystem->unk_169C.cameraAngleConfigList;
    DistortionWorldCameraAngleConfiguration *cameraAngleConfig = cameraAngleConfigList->cameraAngleConfigs;
    int i = cameraAngleConfigList->cameraAngleConfigCount;

    while (i) {
        if (playerDir == cameraAngleConfig->playerDirection) {
            if (DistortionWorldBounds_AreCoordinatesInBounds(playerX, playerY, playerZ, &cameraAngleConfig->bounds)) {
...
static const DistortionWorldCameraAngleConfiguration Unk_ov9_02251E40 = {
    { 0x0, 0x0, 0x0, 0x0 },
    0xF5,
    0xEF,
    0x0,
...
static const DistortionWorldCameraAngleConfiguration Unk_ov9_02251888 = {
    { 0x0, 0x0, 0x0, 0x0 },
    0x0,
    0x0,
    0x0,
...
static const DistortionWorldCameraAngleConfiguration Unk_ov9_02251C48 = {
    { 0x0, 0x0, 0x0, 0x0 },
    0x37,
    0xF0,
    0x0,
...
const DistortionWorldCameraAngleConfiguration Unk_ov9_02251D68 = {
    { 0x0, 0x0, 0x0, 0x0 },
    0x10,
    0x0,
    0x0,
...
static int DistortionWorld_CalculateCameraAngleDelta(u16 currentAngleComponent, u16 targetAngleComponent)
{
    ...
    if (fixedAngleComponentDelta > 0x8000) {
        fixedAngleComponentDelta = (fixedAngleComponentDelta + 0x8000) % 0x8000;
