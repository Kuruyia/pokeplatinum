...
static void StartSkyPalettesUpdateTask(DistWorldSystem *param0);
static void FinishSkyPalettesUpdateTask(DistWorldSystem *param0);
static void SkyPalettesUpdateTask(SysTask *param0, void *param1);
...
static void InitSkyBackground(DistWorldSystem *param0);
static void FinishSkyBackground(DistWorldSystem *param0);
static void InitSkyClouds(DistWorldSystem *param0, DistWorldSkyClouds *param1, NARC *param2);
static void FreeSkyClouds(DistWorldSkyClouds *param0);
static void Task_SkyCloudSpritesUpdate(SysTask *param0, void *param1);
static Sprite *CreateSkyCloudSprite(DistWorldSkyClouds *param0, const VecFx32 *param1, u32 param2, u32 param3, u32 param4, u32 param5, int param6, int param7);
static void InitSkyCloudAnimators(DistWorldSystem *param0, FieldEffectManager *param1, DistWorldSkyClouds *param2);
...
static void InitSkyBackgroundDarkness(DistWorldSystem *param0);
static void Dummy0224F760(DistWorldSystem *param0);
static void RecalculateSkyBackgroundDarkness(DistWorldSystem *param0);
static void UpdateSkyPalettes(DistWorldSystem *param0);
...
static void StartSkyPalettesUpdateTask(DistWorldSystem *system)
{
    ...
    system->skyPalettesTask = SysTask_ExecuteOnVBlank(SkyPalettesUpdateTask, system, 128);
}
...
static void SkyPalettesUpdateTask(SysTask *sysTask, void *sysTaskParam)
{
...
static void RecalculateSkyBackgroundDarkness(DistWorldSystem *system)
{
    ...
    if (skyBg->darknessCalculationDisabled == FALSE) {
        skyBg->darknessLevel = (playerPos->y - (DISTORTION_WORLD_MIN_Y << 4) * FX32_ONE) / ((((DISTORTION_WORLD_MAX_Y - DISTORTION_WORLD_MIN_Y) << 4) * FX32_ONE) / 12);
    }
