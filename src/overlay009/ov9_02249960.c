...
#define SKYBOX_BACKGROUND_MIN_DARKNESS 0
#define SKYBOX_BACKGROUND_MAX_DARKNESS 12

#define SKYBOX_CLOUD_SPRITE_LIST_CAPACITY 16
#define SKYBOX_CLOUD_RESOURCE_COUNT       7
#define SKYBOX_CLOUD_RESOURCE_BASE_ID     0xFF
#define SKYBOX_CLOUD_PALETTE_COUNT        5
#define SKYBOX_CLOUD_COUNT                9
#define SKYBOX_CLOUD_GROUP_COUNT          4
#define SKYBOX_CLOUD_VIEW_RECT_X          (FX32_ONE * 0)
#define SKYBOX_CLOUD_VIEW_RECT_Y          (FX32_ONE * -512)
...
#define GIRATINA_ROOM_PLAY_APPEARANCE_SKYBOX_DARKNESS_TARGET    (FX32_ONE * SKYBOX_BACKGROUND_MAX_DARKNESS)
...
#define CASCADE_DOWN_FIRST_CASCADE_STEPS                 70
#define CASCADE_DOWN_SECOND_CASCADE_STEPS                30
...
enum EventCmdKind {
    ...
    EVENT_CMD_SET_PERSISTED_BOULDER_PUZZLE_FLAG,
    EVENT_CMD_CASCADE_DOWN,
    EVENT_CMD_PLAY_GIRATINA_ROOM_APPEARANCE,
    ...
    EVENT_CMD_CLEAR_PERSISTED_BOULDER_PUZZLE_FLAG,
...
enum EventCmdCascadeDownState {
    ...
    EVENT_CMD_CASCADE_DOWN_STATE_COUNT,
};
...
enum EventCmdCascadeUpState {
    ...
    EVENT_CMD_CASCADE_UP_STATE_COUNT,
};
...
enum SkyboxKind {
    SKYBOX_KIND_NORMAL = 0,
    SKYBOX_KIND_GIRATINA_ROOM,
    SKYBOX_KIND_GIRATINA_ROOM_DARK,
    SKYBOX_KIND_COUNT,
};
...
typedef struct DistWorldSkyboxCloudResourceIDs {
    u8 charResID;
    u8 plttResID;
    u8 cellResID;
    u8 animResID;
} DistWorldSkyboxCloudResourceIDs;

typedef struct DistWorldSkyboxClouds {
    ...
    SpriteResource *charRes[SKYBOX_CLOUD_RESOURCE_COUNT];
    SpriteResource *plttRes;
    SpriteResource *cellRes[SKYBOX_CLOUD_RESOURCE_COUNT];
    SpriteResource *animRes[SKYBOX_CLOUD_RESOURCE_COUNT];
    SysTask *updateTask;
} DistWorldSkyboxClouds;
...
typedef struct DistWorldSkyboxBackground {
    s16 darknessLevel;
    ...
    u16 baseCloudPalettes[PALETTE_SIZE * SKYBOX_CLOUD_PALETTE_COUNT];
    u16 currCloudPalettes[PALETTE_SIZE * SKYBOX_CLOUD_PALETTE_COUNT];
} DistWorldSkyboxBackground;

typedef struct DistWorldSkyboxCloudTemplate {
    int resIDsIndex;
    int group;
    ...
    VecFx32 basePos;
    VecFx32 scale;
} DistWorldSkyboxCloudTemplate;

typedef struct DistWorldSkyboxCloudAnimatorUserData {
    DistWorldSystem *system;
    DistWorldSkyboxCloudTemplate template;
    DistWorldSkyboxClouds *clouds;
} DistWorldSkyboxCloudAnimatorUserData;

typedef struct DistWorldSkyboxCloudAnimator {
    fx32 rotAngle;
    fx32 rotAngleDelta;
    DistWorldSkyboxCloudAnimatorUserData userData;
    Sprite *sprite;
} DistWorldSkyboxCloudAnimator;
...
struct DistWorldSystem {
    ...
    DistWorldSkyboxClouds skyboxClouds;
    ...
    DistWorldSkyboxBackground skyboxBg;
...
typedef struct DistWorldEventCmdAddMapObjWithLocalIDParams {
    u16 mapHeaderID;
    u16 mapObjLocalID;
} DistWorldEventCmdAddMapObjWithLocalIDParams;

typedef struct DistWorldEventCmdDeleteMapObjWithLocalIDParams {
    u32 mapObjLocalID;
} DistWorldEventCmdDeleteMapObjWithLocalIDParams;
...
typedef struct DistWorldEventCmdCascadeBaseParams {
    u32 movementAxis;
    u16 movementDir;
    ...
    VecFx32 posDelta;
} DistWorldEventCmdCascadeBaseParams;

typedef struct DistWorldEventCmdCascadeBaseRunData {
...
} DistWorldEventCmdCascadeBaseRunData;

typedef struct DistWorldEventCmdCascadeDownParams {
    DistWorldEventCmdCascadeBaseParams base;
} DistWorldEventCmdCascadeDownParams;

typedef struct DistWorldEventCmdCascadeDownRunData {
    s16 spriteRotationAnimStepsLeft;
    u16 moveAwayAnimStep;
    u16 cameraAngleState;
    s16 cameraAngleDelay;
    s16 firstCascadeAnimStepsLeft;
    s16 secondCascadeAnimStepsLeft;
    ...
    DistWorldEventCmdCascadeBaseRunData base;
} DistWorldEventCmdCascadeDownRunData;

typedef struct DistWorldEventCmdCascadeUpParams {
    DistWorldEventCmdCascadeBaseParams base;
} DistWorldEventCmdCascadeUpParams;

typedef struct DistWorldEventCmdCascadeUpRunData {
    s16 spriteRotationAnimStepsLeft;
    u16 moveAwayAnimStep;
    u16 cameraAngleState;
    s16 dummy06;
    ...
    fx32 orbitAngleDelta;
    DistWorldEventCmdCascadeBaseRunData base;
} DistWorldEventCmdCascadeUpRunData;

typedef struct DistWorldEventCmdStartScriptParams {
    u32 scriptID;
} DistWorldEventCmdStartScriptParams;

typedef struct DistWorldEventCmdSetDistortionWorldProgressParams {
    u32 progress;
} DistWorldEventCmdSetDistortionWorldProgressParams;

typedef struct DistWorldEventCmdSetGiratinaAnimationFlagParams {
...
} DistWorldEventCmdShowUxieBoulderTutoRunData;

typedef struct DistWorldEventCmdShowAzelfBoulderTutoRunData {
    fx32 descendYDelta;
    VecFx32 azelfSpritePosOffset;
    SysTask *azelfAnimTask;
    MapObject *azelfMapObj;
} DistWorldEventCmdShowAzelfBoulderTutoRunData;

typedef struct DistWorldEventCmdShowMespritBoulderTutoRunData {
    fx32 descendYDelta;
...
static void StartSkyboxPalettesUpdateTask(DistWorldSystem *param0);
static void FinishSkyboxPalettesUpdateTask(DistWorldSystem *param0);
static void SkyboxPalettesUpdateTask(SysTask *param0, void *param1);
...
static void InitSkyboxBackground(DistWorldSystem *param0);
static void FinishSkyboxBackground(DistWorldSystem *param0);
static void InitSkyboxClouds(DistWorldSystem *param0, DistWorldSkyboxClouds *param1, NARC *param2);
static void FreeSkyboxClouds(DistWorldSkyboxClouds *param0);
static void Task_SkyboxCloudSpritesUpdate(SysTask *param0, void *param1);
static Sprite *CreateSkyboxCloudSprite(DistWorldSkyboxClouds *param0, const VecFx32 *param1, u32 param2, u32 param3, u32 param4, u32 param5, int param6, int param7);
static void InitSkyboxCloudAnimators(DistWorldSystem *param0, FieldEffectManager *param1, DistWorldSkyboxClouds *param2);
...
static void Dummy0224CC4C(DistWorldSystem *param0);
...
static void InitSkyboxBackgroundDarkness(DistWorldSystem *param0);
static void Dummy0224F760(DistWorldSystem *param0);
static void RecalculateSkyboxBackgroundDarkness(DistWorldSystem *param0);
static void UpdateSkyboxPalettes(DistWorldSystem *param0);
static void SetSkyboxBackgroundDarknessCalculationDisabled(DistWorldSystem *param0, BOOL param1);
static void SetSkyboxBackgroundDarknessLevel(DistWorldSystem *param0, s16 param1);
...
static const OverworldAnimManagerFuncs sSkyboxCloudsAnimFuncs;
...
static const int sSkyboxCloudsCharNARCIndexes[SKYBOX_CLOUD_RESOURCE_COUNT];
static const int sSkyboxCloudsCellNARCIndexes[SKYBOX_CLOUD_RESOURCE_COUNT];
static const int sSkyboxCloudsAnimNARCIndexes[SKYBOX_CLOUD_RESOURCE_COUNT];
static const int sSkyboxCloudsPlttNARCIndexes[1];
static const DistWorldSkyboxCloudResourceIDs sSkyboxCloudsResIDs[SKYBOX_CLOUD_RESOURCE_COUNT];
static const DistWorldSkyboxCloudTemplate sSkyboxCloudsTemplates[SKYBOX_CLOUD_COUNT];
static const fx32 sSkyboxCloudsRotAngleDeltas[SKYBOX_KIND_COUNT][SKYBOX_CLOUD_GROUP_COUNT];
...
void DistWorld_DynamicMapFeaturesInit(FieldSystem *fieldSystem)
{
    ...
    InitSkyboxBackground(dwSystem);
    ov9_0224B3A8(dwSystem);
    InitSkyboxClouds(dwSystem, &dwSystem->skyboxClouds, dwSystem->etcNARC);
    InitSkyboxBackgroundDarkness(dwSystem);
    CameraInit(dwSystem);
    ...
    InitSkyboxCloudAnimators(dwSystem, dwSystem->fieldSystem->fieldEffMan, &dwSystem->skyboxClouds);
    Dummy0224E984(dwSystem);
    ov5_021F34B8(dwSystem->fieldSystem->fieldEffMan);
    StartSkyboxPalettesUpdateTask(dwSystem);
...
void DistWorld_DynamicMapFeaturesFree(FieldSystem *fieldSystem)
{
    ...
    FinishSkyboxPalettesUpdateTask(v0);
    ...
    CameraFree(v0);
    Dummy0224F760(v0);
    FreeSkyboxClouds(&v0->skyboxClouds);
    ov9_0224B3F4(v0);
    FinishSkyboxBackground(v0);
...
static void ov9_02249CC4(DistWorldSystem *param0)
{
    ...
    if (!SystemFlag_HandleDistortionWorldPuzzleFinished(v1, HANDLE_FLAG_CHECK)) {
        ...
        v0->boulderPuzzleFlags |= 1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_TUTO_SEEN
            ...
            | 1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_BOULDER_IN_B6F_PIT
            | 1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_BOULDER_IN_B6F_PIT
            | 1 << DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_BOULDER_IN_B6F_PIT;
    }
}
...
static void ov9_02249EDC(SysTask *param0, void *param1)
{
    ...
    {
        RecalculateSkyboxBackgroundDarkness(v0);
    }
}

static void StartSkyboxPalettesUpdateTask(DistWorldSystem *system)
{
    GF_ASSERT(system->skyboxPalettesTask == NULL);
    system->skyboxPalettesTask = SysTask_ExecuteOnVBlank(SkyboxPalettesUpdateTask, system, 128);
}

static void FinishSkyboxPalettesUpdateTask(DistWorldSystem *system)
{
    GF_ASSERT(system->skyboxPalettesTask != NULL);
    SysTask_Done(system->skyboxPalettesTask);
    system->skyboxPalettesTask = NULL;
}

static void SkyboxPalettesUpdateTask(SysTask *sysTask, void *sysTaskParam)
{
    DistWorldSystem *system = sysTaskParam;

    Dummy0224CC4C(system);
    UpdateSkyboxPalettes(system);
}
...
static void InitSkyboxBackground(DistWorldSystem *system)
{
    ...
    DistWorldSkyboxBackground *skyboxBg = &system->skyboxBg;
    u16 *plttRawData = plttData->pRawData;

    for (int i = 0; i < PALETTE_SIZE; i++) {
        skyboxBg->basePalette[i] = plttRawData[i];
        skyboxBg->currPalette[i] = plttRawData[i];
    }
...
static void FinishSkyboxBackground(DistWorldSystem *system)
{
    G2_BlendNone();
}

static void InitSkyboxClouds(DistWorldSystem *system, DistWorldSkyboxClouds *clouds, NARC *etcNARC)
{
    clouds->spriteList = SpriteList_InitRendering(SKYBOX_CLOUD_SPRITE_LIST_CAPACITY, &clouds->renderer, HEAP_ID_FIELD1);
    SetMainScreenViewRect(&clouds->renderer, SKYBOX_CLOUD_VIEW_RECT_X, SKYBOX_CLOUD_VIEW_RECT_Y);
    clouds->charResColl = SpriteResourceCollection_New(SKYBOX_CLOUD_RESOURCE_COUNT, SPRITE_RESOURCE_CHAR, HEAP_ID_FIELD1);
    clouds->plttResColl = SpriteResourceCollection_New(1, SPRITE_RESOURCE_PLTT, HEAP_ID_FIELD1);
    clouds->cellResColl = SpriteResourceCollection_New(SKYBOX_CLOUD_RESOURCE_COUNT, SPRITE_RESOURCE_CELL, HEAP_ID_FIELD1);
    clouds->animResColl = SpriteResourceCollection_New(SKYBOX_CLOUD_RESOURCE_COUNT, SPRITE_RESOURCE_ANIM, HEAP_ID_FIELD1);

    int i;
    for (i = 0; i < SKYBOX_CLOUD_RESOURCE_COUNT; i++) {
        clouds->charRes[i] = SpriteResourceCollection_AddTilesFrom(clouds->charResColl, etcNARC, sSkyboxCloudsCharNARCIndexes[i], FALSE, SKYBOX_CLOUD_RESOURCE_BASE_ID + i, NNS_G2D_VRAM_TYPE_2DMAIN, HEAP_ID_FIELD1);
        SpriteTransfer_RequestCharAtEnd(clouds->charRes[i]);
    }

    clouds->plttRes = SpriteResourceCollection_AddPaletteFrom(clouds->plttResColl, etcNARC, sSkyboxCloudsPlttNARCIndexes[0], FALSE, SKYBOX_CLOUD_RESOURCE_BASE_ID, NNS_G2D_VRAM_TYPE_2DMAIN, 5, HEAP_ID_FIELD1);

    NNSG2dPaletteData *plttData = SpriteResource_GetPaletteFade(clouds->plttRes);
    int j = 0;
    DistWorldSkyboxBackground *skyboxBg = &system->skyboxBg;
    u16 *basePlttIter = skyboxBg->baseCloudPalettes;
    ...
    do {
        *basePlttIter = *plttIter;
        basePlttIter++;
        plttIter++;
    } while (++j < PALETTE_SIZE * SKYBOX_CLOUD_PALETTE_COUNT);

    SpriteTransfer_RequestPlttFreeSpace(clouds->plttRes);

    for (i = 0; i < SKYBOX_CLOUD_RESOURCE_COUNT; i++) {
        clouds->cellRes[i] = SpriteResourceCollection_AddFrom(clouds->cellResColl, etcNARC, sSkyboxCloudsCellNARCIndexes[i], FALSE, SKYBOX_CLOUD_RESOURCE_BASE_ID + i, SPRITE_RESOURCE_CELL, HEAP_ID_FIELD1);
    }

    for (i = 0; i < SKYBOX_CLOUD_RESOURCE_COUNT; i++) {
        clouds->animRes[i] = SpriteResourceCollection_AddFrom(clouds->animResColl, etcNARC, sSkyboxCloudsAnimNARCIndexes[i], FALSE, SKYBOX_CLOUD_RESOURCE_BASE_ID + i, SPRITE_RESOURCE_ANIM, HEAP_ID_FIELD1);
    }

    clouds->updateTask = SysTask_Start(Task_SkyboxCloudSpritesUpdate, clouds, 65535);
}

static void FreeSkyboxClouds(DistWorldSkyboxClouds *clouds)
{
    SysTask_Done(clouds->updateTask);

    for (int i = 0; i < SKYBOX_CLOUD_RESOURCE_COUNT; i++) {
...
static void Task_SkyboxCloudSpritesUpdate(SysTask *sysTask, void *sysTaskParam)
{
    DistWorldSkyboxClouds *clouds = sysTaskParam;
    SpriteList_Update(clouds->spriteList);
}

static Sprite *CreateSkyboxCloudSprite(DistWorldSkyboxClouds *clouds, const VecFx32 *pos, u32 charResID, u32 plttResID, u32 cellResID, u32 animResID, int headerPriority, int listPriority)
{
    SpriteResourcesHeader resHeader;
    SpriteResourcesHeader_Init(
        &resHeader,
        SKYBOX_CLOUD_RESOURCE_BASE_ID + charResID,
        SKYBOX_CLOUD_RESOURCE_BASE_ID + plttResID,
        SKYBOX_CLOUD_RESOURCE_BASE_ID + cellResID,
        SKYBOX_CLOUD_RESOURCE_BASE_ID + animResID,
        RESOURCE_NONE,
        RESOURCE_NONE,
        FALSE,
        headerPriority,
...
static void InitSkyboxCloudAnimators(DistWorldSystem *system, FieldEffectManager *fieldEffMan, DistWorldSkyboxClouds *clouds)
{
    system->skyboxKind = SKYBOX_KIND_NORMAL;
    ...
    if (DistWorldSystem_GetMapHeaderID(system) == MAP_HEADER_DISTORTION_WORLD_GIRATINA_ROOM) {
        ...
        if (distWorldProgress >= 10) {
            if (distWorldProgress <= 12) {
                system->skyboxKind = SKYBOX_KIND_GIRATINA_ROOM;
            } else if (distWorldProgress <= 13) {
                system->skyboxKind = SKYBOX_KIND_GIRATINA_ROOM_DARK;
            }
        }
    }
    ...
    for (int i = 0; i < SKYBOX_CLOUD_COUNT; i++) {
        userData.template = sSkyboxCloudsTemplates[i];
        FieldEffectManager_InitAnimManager(fieldEffMan, &sSkyboxCloudsAnimFuncs, NULL, 0, &userData, 0);
    }
}

static BOOL DistWorldSkyboxCloudAnimator_AnimInit(OverworldAnimManager *animMan, void *context)
{
    VecFx32 pos = { 0, 0, 0 };
    const DistWorldSkyboxCloudAnimatorUserData *userData = OverworldAnimManager_GetUserData(animMan);
    DistWorldSkyboxCloudAnimator *animator = context;

    animator->userData = *userData;
    animator->rotAngle = animator->userData.template.initialRotAngle;
    animator->rotAngleDelta = sSkyboxCloudsRotAngleDeltas[userData->system->skyboxKind][userData->template.group];

    const DistWorldSkyboxCloudResourceIDs *resIDs = &sSkyboxCloudsResIDs[animator->userData.template.resIDsIndex];
    animator->sprite = CreateSkyboxCloudSprite(animator->userData.clouds, &pos, resIDs->charResID, resIDs->plttResID, resIDs->cellResID, resIDs->animResID, 3, 0xFFFF);

    Sprite_SetAffineScaleEx(animator->sprite, &animator->userData.template.scale, AFFINE_OVERWRITE_MODE_DOUBLE);
    return TRUE;
}

static void DistWorldSkyboxCloudAnimator_AnimExit(OverworldAnimManager *animMan, void *context)
{
    DistWorldSkyboxCloudAnimator *animator = context;
    Sprite_Delete(animator->sprite);
}

static void DistWorldSkyboxCloudAnimator_AnimTick(OverworldAnimManager *animMan, void *context)
{
    DistWorldSkyboxCloudAnimator *animator = context;
    fx32 expectedRotAngleDelta = sSkyboxCloudsRotAngleDeltas[animator->userData.system->skyboxKind][animator->userData.template.group];
    ...
    pos.x += SKYBOX_CLOUD_VIEW_RECT_X + CalcCosineDegrees(animator->rotAngle / FX32_ONE) * animator->userData.template.distToCenter;
    pos.y += SKYBOX_CLOUD_VIEW_RECT_Y + CalcSineDegrees(animator->rotAngle / FX32_ONE) * animator->userData.template.distToCenter;
...
static void DistWorldSkyboxCloudAnimator_AnimRender(OverworldAnimManager *animMan, void *context)
{
}

static const OverworldAnimManagerFuncs sSkyboxCloudsAnimFuncs = {
    sizeof(DistWorldSkyboxCloudAnimator),
    DistWorldSkyboxCloudAnimator_AnimInit,
    DistWorldSkyboxCloudAnimator_AnimExit,
    DistWorldSkyboxCloudAnimator_AnimTick,
    DistWorldSkyboxCloudAnimator_AnimRender
};
...
{
    DistWorldEventCmdSetMapObjectAnimationRunData *runData = ResetLoadedEventDataBuffer(system, sizeof(DistWorldEventCmdSetMapObjectAnimationRunData));
...
static int EventCmdSetMapObjectAnimation_Start(DistWorldSystem *system, FieldTask *task, u16 *cmdState, const void *params)
{
    ...
    DistWorldEventCmdSetMapObjectAnimationRunData *runData = GetLoadedEventDataBuffer(system);
...
static int EventCmdMovePlatform_BeginMovement(DistWorldSystem *system, FieldTask *task, u16 *cmdState, const void *params)
{
    ...
    DistWorldEventCmdMovePlatformRunData *runData = ResetLoadedEventDataBuffer(system, sizeof(DistWorldEventCmdMovePlatformRunData));
...
static int EventCmdMovePlatform_Vibrate(DistWorldSystem *system, FieldTask *task, u16 *cmdState, const void *params)
{
    ...
    const DistWorldEventCmdMovePlatformParams *cmdParams = params;
    DistWorldEventCmdMovePlatformRunData *runData = GetLoadedEventDataBuffer(system);
    VecFx32 *movingPlatformPos = GetMovingPlatformPropPos(runData->animator->animMan);
...
{
    const DistWorldEventCmdAddMapObjWithLocalIDParams *cmdParams = params;
    AddMapObjectWithLocalID(system, cmdParams->mapHeaderID, cmdParams->mapObjLocalID);

    return EVENT_CMD_HANDLER_RES_FINISH;
}

static const DistWorldEventCmdHandler sEventCmdAddMapObjWithLocalID[1] = {
...
{
    const DistWorldEventCmdDeleteMapObjWithLocalIDParams *cmdParams = params;
    DistWorld_DeleteMapObjectWithLocalID(system->fieldSystem, cmdParams->mapObjLocalID);

    return EVENT_CMD_HANDLER_RES_FINISH;
}

static const DistWorldEventCmdHandler sEventCmdDeleteMapObjWithLocalID[1] = {
...
static void InitSkyboxBackgroundDarkness(DistWorldSystem *system)
{
    DistWorldSkyboxBackground *skyboxBg = &system->skyboxBg;
    u32 mapHeaderID = DistWorldSystem_GetMapHeaderID(system);
    ...
    if (mapHeaderID == MAP_HEADER_DISTORTION_WORLD_GIRATINA_ROOM) {
        ...
        if (SystemVars_GetDistortionWorldProgress(varsFlags) == 13) {
            skyboxBg->darknessCalculationDisabled = TRUE;
            skyboxBg->darknessLevel = SKYBOX_BACKGROUND_MAX_DARKNESS;
        }
    }

    skyboxBg->renderedDarknessLevel = -1;
}
...
static void RecalculateSkyboxBackgroundDarkness(DistWorldSystem *system)
{
    DistWorldSkyboxBackground *skyboxBg = &system->skyboxBg;
    PlayerAvatar *playerAvatar = system->fieldSystem->playerAvatar;
    const VecFx32 *playerPos = PlayerAvatar_PosVector(playerAvatar);

    if (skyboxBg->darknessCalculationDisabled == FALSE) {
        skyboxBg->darknessLevel = (playerPos->y - (DISTORTION_WORLD_MIN_Y << 4) * FX32_ONE) / ((((DISTORTION_WORLD_MAX_Y - DISTORTION_WORLD_MIN_Y) << 4) * FX32_ONE) / 12);
    }

    if (skyboxBg->darknessLevel < SKYBOX_BACKGROUND_MIN_DARKNESS) {
        skyboxBg->darknessLevel = SKYBOX_BACKGROUND_MIN_DARKNESS;
    } else if (skyboxBg->darknessLevel > SKYBOX_BACKGROUND_MAX_DARKNESS) {
        skyboxBg->darknessLevel = SKYBOX_BACKGROUND_MAX_DARKNESS;
    }

    if (skyboxBg->darknessLevel != skyboxBg->renderedDarknessLevel) {
        int i = 0;

        do {
            CalculateTintedColor(skyboxBg->basePalette[i], GX_RGB(4, 4, 8), skyboxBg->darknessLevel, &skyboxBg->currPalette[i]);
            i++;
        ...
        do {
            CalculateTintedColor(skyboxBg->baseCloudPalettes[i], GX_RGB(6, 6, 8), skyboxBg->darknessLevel, &skyboxBg->currCloudPalettes[i]);
            i++;
        } while (i < PALETTE_SIZE * SKYBOX_CLOUD_PALETTE_COUNT);

        skyboxBg->dirty = TRUE;
        skyboxBg->renderedDarknessLevel = skyboxBg->darknessLevel;
    }
}

static void UpdateSkyboxPalettes(DistWorldSystem *system)
{
    DistWorldSkyboxBackground *skyboxBg = &system->skyboxBg;

    if (skyboxBg->dirty == TRUE) {
        Bg_LoadPalette(BG_LAYER_MAIN_2, skyboxBg->currPalette, PALETTE_SIZE_BYTES, 0);

        DistWorldSkyboxClouds *clouds = &system->skyboxClouds;
        ...
        DC_FlushRange(skyboxBg->currCloudPalettes, PALETTE_SIZE_BYTES * SKYBOX_CLOUD_PALETTE_COUNT);
        GX_LoadOBJPltt(skyboxBg->currCloudPalettes, plttLocation, PALETTE_SIZE_BYTES * SKYBOX_CLOUD_PALETTE_COUNT);

        skyboxBg->dirty = FALSE;
    }
}

static void SetSkyboxBackgroundDarknessCalculationDisabled(DistWorldSystem *system, BOOL darknessCalculationDisabled)
{
    DistWorldSkyboxBackground *skyboxBg = &system->skyboxBg;
    skyboxBg->darknessCalculationDisabled = darknessCalculationDisabled;
}

static void SetSkyboxBackgroundDarknessLevel(DistWorldSystem *system, s16 darknessLevel)
{
    DistWorldSkyboxBackground *skyboxBg = &system->skyboxBg;
    skyboxBg->darknessLevel = darknessLevel;
}
...
static void DistWorldEventCmdCascadeBaseRunData_InitFromParams(DistWorldSystem *system, DistWorldEventCmdCascadeBaseRunData *runData, const DistWorldEventCmdCascadeBaseParams *params, const VecFx32 *playerPos)
{
...
static void DistWorldEventCmdCascadeBaseRunData_InitBobbing(DistWorldEventCmdCascadeBaseRunData *runData, enum Axis axis, fx32 delta, fx32 max)
{
    switch (axis) {
    case AXIS_X:
...
static BOOL DistWorldEventCmdCascadeBaseRunData_Update(DistWorldSystem *system, DistWorldEventCmdCascadeBaseRunData *runData)
{
    if (runData->currPosOffset.x != runData->finalPosOffset.x) {
        runData->currPosOffset.x += runData->posDelta.x;
...
static void UpdateCascadeDownCamera(DistWorldSystem *system, DistWorldEventCmdCascadeDownRunData *runData)
{
    MapObject *playerMapObj = Player_MapObject(system->fieldSystem->playerAvatar);
...
{
    DistWorldEventCmdCascadeDownRunData *runData = ResetLoadedEventDataBuffer(system, sizeof(DistWorldEventCmdCascadeDownRunData));
    const DistWorldEventCmdCascadeDownParams *cmdParams = params;
    DistWorldEventCmdCascadeBaseRunData *baseRunData = &runData->base;
    PlayerAvatar *playerAvatar = system->fieldSystem->playerAvatar;
    MapObject *playerMapObj = Player_MapObject(playerAvatar);
    ...
    MapObject_GetPosPtr(playerMapObj, &playerPos);
    MapObject_TryFace(playerMapObj, FACE_LEFT);
    DistWorldEventCmdCascadeBaseRunData_InitFromParams(system, baseRunData, &cmdParams->base, &playerPos);
    ...
    DistWorldSurfMountRenderer_SetMultipleFlags(
        mountAnimMan,
...
{
    MapObject *playerMapObj = Player_MapObject(system->fieldSystem->playerAvatar);
    DistWorldEventCmdCascadeDownRunData *runData = GetLoadedEventDataBuffer(system);
    DistWorldEventCmdCascadeBaseRunData *baseRunData = &runData->base;

    DistWorldEventCmdCascadeBaseRunData_Update(system, baseRunData);
    ...
    if (runData->spriteRotationAnimStepsLeft == 0) {
        ...
        DistWorldEventCmdCascadeBaseRunData_InitBobbing(baseRunData, AXIS_X, CASCADE_DOWN_BOBBING_DELTA, CASCADE_DOWN_BOBBING_MAX);
        ...
        runData->firstCascadeAnimStepsLeft = CASCADE_DOWN_FIRST_CASCADE_STEPS;
        runData->secondCascadeAnimStepsLeft = -1;
        runData->mountPosFixDelta.x = CASCADE_DOWN_FIRST_CASCADE_MOUNT_POSITION_FIX_X / runData->firstCascadeAnimStepsLeft;
        runData->mountPosFixDelta.y = CASCADE_DOWN_FIRST_CASCADE_MOUNT_POSITION_FIX_Y / runData->firstCascadeAnimStepsLeft;
        runData->mountPosFixDelta.z = CASCADE_DOWN_FIRST_CASCADE_MOUNT_POSITION_FIX_Z / runData->firstCascadeAnimStepsLeft;
        runData->bobbingFixDelta = CASCADE_DOWN_FIRST_CASCADE_BOBBING_FIX / runData->firstCascadeAnimStepsLeft;
...
static int EventCmdCascadeDown_CascadeDown(DistWorldSystem *system, FieldTask *task, u16 *cmdState, const void *params)
{
    ...
    updateRes = DistWorldEventCmdCascadeBaseRunData_Update(system, baseRunData);
    MapObject_SetPos(playerMapObj, &baseRunData->playerPos);
    ...
    *mountSpritePosOffset = baseRunData->jumpOffset;
    ...
    if (runData->cameraAngleState == 1) {
        if (runData->firstCascadeAnimStepsLeft > 0) {
            runData->firstCascadeAnimStepsLeft--;
            mountPosFix->x += runData->mountPosFixDelta.x;
            mountPosFix->y += runData->mountPosFixDelta.y;
            mountPosFix->z += runData->mountPosFixDelta.z;
        ...
        if (runData->secondCascadeAnimStepsLeft < 0) {
            runData->secondCascadeAnimStepsLeft = CASCADE_DOWN_SECOND_CASCADE_STEPS;
            runData->mountPosFixDelta.x = CASCADE_DOWN_SECOND_CASCADE_MOUNT_POSITION_FIX_X / runData->secondCascadeAnimStepsLeft;
            runData->mountPosFixDelta.y = CASCADE_DOWN_SECOND_CASCADE_MOUNT_POSITION_FIX_Y / runData->secondCascadeAnimStepsLeft;
            runData->mountPosFixDelta.z = CASCADE_DOWN_SECOND_CASCADE_MOUNT_POSITION_FIX_Z / runData->secondCascadeAnimStepsLeft;
            runData->bobbingFixDelta = CASCADE_DOWN_SECOND_CASCADE_BOBBING_FIX / runData->secondCascadeAnimStepsLeft;
        }

        if (runData->secondCascadeAnimStepsLeft > 0) {
            runData->secondCascadeAnimStepsLeft--;
            mountPosFix->x += runData->mountPosFixDelta.x;
            mountPosFix->y += runData->mountPosFixDelta.y;
            mountPosFix->z += runData->mountPosFixDelta.z;
            runData->bobbingFix += runData->bobbingFixDelta;
    ...
    if (updateRes == CASCADE_UPDATE_RES_FINISHING_POS_REACHED) {
        ...
        DistWorldSurfMountRenderer_ClearMultipleFlags(mountAnimMan, DIST_WORLD_SURF_MOUNT_RENDERER_FLAG_MASK_USE_EXTERNAL_SPRITE_POS_OFFSET);
...
static int EventCmdCascadeDown_FinishCascading(DistWorldSystem *system, FieldTask *task, u16 *cmdState, const void *params)
{
    ...
    if (updateRes == CASCADE_UPDATE_RES_FINAL_POS_REACHED) {
        const DistWorldEventCmdCascadeDownParams *cmdParams = params;
        const DistWorldEventCmdCascadeBaseParams *baseCmdParams = &cmdParams->base;
        ...
        *mountPosFix2 = zeroVec;
        ...
        DistWorldSurfMountRenderer_ClearMultipleFlags(
            mountAnimMan,
            DIST_WORLD_SURF_MOUNT_RENDERER_FLAG_MASK_NO_ROTATION_RECALCULATION
                | DIST_WORLD_SURF_MOUNT_RENDERER_FLAG_MASK_NO_ORBIT_RECALCULATION
                | DIST_WORLD_SURF_MOUNT_RENDERER_FLAG_MASK_USE_EXTERNAL_POS_FIX
...
static const DistWorldEventCmdHandler sEventCmdCascadeDownHandlers[EVENT_CMD_CASCADE_DOWN_STATE_COUNT] = {
...
static const DistWorldCameraAngleTemplate sCascadeUpCameraAngle = {
    ...
    .angleZ = 0x0,
    .playerDir = FACE_UP,
    .transitionSteps = 0x10
};

static void UpdateCascadeUpCamera(DistWorldSystem *system, DistWorldEventCmdCascadeUpRunData *runData)
{
    MapObject *playerMapObj = Player_MapObject(system->fieldSystem->playerAvatar);
    int yOffset = (runData->base.currPosOffset.y >> 4) / FX32_ONE;
...
{
    const DistWorldEventCmdCascadeUpParams *cmdParams = params;
    DistWorldEventCmdCascadeUpRunData *runData = ResetLoadedEventDataBuffer(system, sizeof(DistWorldEventCmdCascadeUpRunData));
    DistWorldEventCmdCascadeBaseRunData *baseRunData = &runData->base;
    PlayerAvatar *playerAvatar = system->fieldSystem->playerAvatar;
    MapObject *playerMapObj = Player_MapObject(playerAvatar);
...
{
    MapObject *playerMapObj = Player_MapObject(system->fieldSystem->playerAvatar);
    DistWorldEventCmdCascadeUpRunData *runData = GetLoadedEventDataBuffer(system);
    DistWorldEventCmdCascadeBaseRunData *baseRunData = &runData->base;
    ...
    if (runData->spriteRotationAnimStepsLeft == 0) {
        ...
        DistWorldEventCmdCascadeBaseRunData_InitBobbing(baseRunData, AXIS_X, CASCADE_UP_BOBBING_DELTA, CASCADE_UP_BOBBING_MAX);
...
static const DistWorldEventCmdHandler sEventCmdCascadeUpHandlers[EVENT_CMD_CASCADE_UP_STATE_COUNT] = {
...
{
    const DistWorldEventCmdStartScriptParams *cmdParams = params;
...
static const DistWorldEventCmdHandler sEventCmdStartScriptHandlers[2] = {
...
{
    const DistWorldEventCmdSetDistortionWorldProgressParams *cmdParams = params;
    VarsFlags *varsFlags = SaveData_GetVarsFlags(system->fieldSystem->saveData);
...
static const DistWorldEventCmdHandler sEventCmdSetDistortionWorldProgressHandlers[1] = {
...
{
    const DistWorldEventCmdSetGiratinaAnimationFlagParams *cmdParams = params;
    VarsFlags *varsFlags = SaveData_GetVarsFlags(system->fieldSystem->saveData);
...
static const DistWorldEventCmdHandler sEventCmdSetGiratinaAnimationFlagHandlers[1] = {
...
static const DistWorldEventCmdHandler sEventCmdShowGiratinaShadow[EVENT_CMD_SHOW_GIRATINA_SHADOW_STATE_COUNT] = {
...
void DistWorld_ApplyGiratinaSpritePalette(FieldSystem *fieldSystem)
{
    ...
    if (dwSystem->playingGiratinaRoomAppearance == TRUE) {
        DistWorldEventCmdPlayGiratinaRoomAppearanceRunData *runData = GetLoadedEventDataBuffer(dwSystem);
...
{
    DistWorldEventCmdPlayGiratinaRoomAppearanceRunData *runData = ResetLoadedEventDataBuffer(system, sizeof(DistWorldEventCmdPlayGiratinaRoomAppearanceRunData));
...
{
    DistWorldEventCmdPlayGiratinaRoomAppearanceRunData *runData = GetLoadedEventDataBuffer(system);
    Billboard *v0 = ov5_021EB1A0(runData->giratinaMapObj);
    ...
    if (v0 != NULL) {
        ...
        runData->skyboxDarkness = SKYBOX_BACKGROUND_MIN_DARKNESS;
        SetSkyboxBackgroundDarknessCalculationDisabled(system, TRUE);
...
static int EventCmdPlayGiratinaRoomAppearance_Descend(DistWorldSystem *system, FieldTask *task, u16 *cmdState, const void *params)
{
    ...
    SetSkyboxBackgroundDarknessLevel(system, runData->skyboxDarkness / FX32_ONE);
...
static int EventCmdPlayGiratinaRoomAppearance_BrightenSprite(DistWorldSystem *system, FieldTask *task, u16 *cmdState, const void *params)
{
    DistWorldEventCmdPlayGiratinaRoomAppearanceRunData *runData = GetLoadedEventDataBuffer(system);
    Billboard *v0 = ov5_021EB1A0(runData->giratinaMapObj);
    NNSG3dResMdl *model = Billboard_GetModel2(v0);
...
{
    DistWorldEventCmdShowUxieBoulderTutoRunData *runData = ResetLoadedEventDataBuffer(system, sizeof(DistWorldEventCmdShowUxieBoulderTutoRunData));
...
{
    DistWorldEventCmdShowUxieBoulderTutoRunData *runData;
...
{
    DistWorldEventCmdShowUxieBoulderTutoRunData *runData = GetLoadedEventDataBuffer(system);
...
static const DistWorldEventCmdHandler sEventCmdShowUxieBoulderTutoHandlers[EVENT_CMD_SHOW_UXIE_BOULDER_TUTO_STATE_COUNT] = {
...
{
    DistWorldEventCmdShowAzelfBoulderTutoRunData *runData = ResetLoadedEventDataBuffer(system, sizeof(DistWorldEventCmdShowAzelfBoulderTutoRunData));
...
{
    DistWorldEventCmdShowAzelfBoulderTutoRunData *runData;
...
{
    DistWorldEventCmdShowAzelfBoulderTutoRunData *runData = GetLoadedEventDataBuffer(system);
...
static const DistWorldEventCmdHandler sEventCmdShowAzelfBoulderTutoHandlers[EVENT_CMD_SHOW_AZELF_BOULDER_TUTO_STATE_COUNT] = {
...
{
    DistWorldEventCmdShowMespritBoulderTutoRunData *runData = ResetLoadedEventDataBuffer(system, sizeof(DistWorldEventCmdShowAzelfBoulderTutoRunData));
...
{
    DistWorldEventCmdShowMespritBoulderTutoRunData *runData;
...
{
    DistWorldEventCmdShowMespritBoulderTutoRunData *runData = GetLoadedEventDataBuffer(system);
...
static const DistWorldEventCmdHandler sEventCmdShowMespritBoulderTutoHandlers[EVENT_CMD_SHOW_MESPRIT_BOULDER_TUTO_STATE_COUNT] = {
...
{
    DistWorldEventCmdShowGiratinaRoomPlatformsRunData *runData = ResetLoadedEventDataBuffer(system, sizeof(DistWorldEventCmdShowGiratinaRoomPlatformsRunData));
...
{
    DistWorldEventCmdShowGiratinaRoomPlatformsRunData *runData = GetLoadedEventDataBuffer(system);
...
{
    DistWorldEventCmdHideGiratinaRoomPlatformsRunData *runData = ResetLoadedEventDataBuffer(system, sizeof(DistWorldEventCmdHideGiratinaRoomPlatformsRunData));
...
{
    DistWorldEventCmdHideGiratinaRoomPlatformsRunData *runData = GetLoadedEventDataBuffer(system);
...
static const DistWorldEventCmdHandler *sEventCmdHandlers[EVENT_CMD_KIND_COUNT] = {
    [EVENT_CMD_SET_MAP_OBJECT_ANIMATION] = sEventCmdSetMapObjectAnimationHandlers,
    [EVENT_CMD_MOVE_PLATFORM] = sEventCmdMovePlatformHandlers,
    [EVENT_CMD_ADD_MAP_OBJECT_WITH_LOCAL_ID] = sEventCmdAddMapObjWithLocalID,
    [EVENT_CMD_DELETE_MAP_OBJECT_WITH_LOCAL_ID] = sEventCmdDeleteMapObjWithLocalID,
    [EVENT_CMD_CASCADE_UP] = sEventCmdCascadeUpHandlers,
    [EVENT_CMD_START_SCRIPT] = sEventCmdStartScriptHandlers,
    [EVENT_CMD_SET_DISTORTION_WORLD_PROGRESS] = sEventCmdSetDistortionWorldProgressHandlers,
    [EVENT_CMD_SHOW_GIRATINA_SHADOW] = sEventCmdShowGiratinaShadow,
    [EVENT_CMD_SET_GIRATINA_ANIMATION_FLAG] = sEventCmdSetGiratinaAnimationFlagHandlers,
    [EVENT_CMD_SET_PERSISTED_BOULDER_PUZZLE_FLAG] = sEventCmdSetPersistedBoulderPuzzleFlagHandlers,
    [EVENT_CMD_CASCADE_DOWN] = sEventCmdCascadeDownHandlers,
    [EVENT_CMD_PLAY_GIRATINA_ROOM_APPEARANCE] = sEventCmdPlayGiratinaRoomAppearanceHandlers,
    [EVENT_CMD_SHOW_UXIE_BOULDER_TUTO] = sEventCmdShowUxieBoulderTutoHandlers,
    [EVENT_CMD_SHOW_AZELF_BOULDER_TUTO] = sEventCmdShowAzelfBoulderTutoHandlers,
    [EVENT_CMD_SHOW_MESPRIT_BOULDER_TUTO] = sEventCmdShowMespritBoulderTutoHandlers,
    [EVENT_CMD_SHOW_GIRATINA_ROOM_PLATFORMS] = sEventCmdShowGiratinaRoomPlatformsHandlers,
    [EVENT_CMD_HIDE_GIRATINA_ROOM_PLATFORMS] = sEventCmdHideGiratinaRoomPlatformsHandlers,
    [EVENT_CMD_CLEAR_PERSISTED_BOULDER_PUZZLE_FLAG] = sEventCmdClearPersistedBoulderPuzzleFlagHandlers
};

static const DistWorldEventCmdStartScriptParams sUnkMapEventCmdParams1F_1_1 = {
    .scriptID = 0x4
};

static const DistWorldEventCmdSetDistortionWorldProgressParams sUnkMapEventCmdParams1F_1_2 = {
    .progress = 0x2
};
...
static const DistWorldEventCmdStartScriptParams sUnkMapEventCmdParamsB1F_1_1 = {
    .scriptID = 0x3
};

static const DistWorldEventCmdSetDistortionWorldProgressParams sUnkMapEventCmdParamsB1F_1_2 = {
    .progress = 0x4
};

static const DistWorldEventCmdAddMapObjWithLocalIDParams sUnkMapEventCmdParamsB1F_1_3 = {
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_1_1 = {
    .platformIndex = 0x1,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_1_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_NORTH
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_1_3 = {
    .platformIndex = 0x1,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_2_1 = {
    .platformIndex = 0x1,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_2_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_SOUTH
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_2_3 = {
    .platformIndex = 0x1,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_3_1 = {
    .platformIndex = 0x2,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_3_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_NORTH
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_3_3 = {
    .platformIndex = 0x2,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_4_1 = {
    .platformIndex = 0x2,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_4_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_SOUTH
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_4_3 = {
    .platformIndex = 0x2,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_5_1 = {
    .platformIndex = 0x3,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_5_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_5_3 = {
    .platformIndex = 0x3,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_6_1 = {
    .platformIndex = 0x3,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_6_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_6_3 = {
    .platformIndex = 0x3,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_7_1 = {
    .platformIndex = 0x5,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_7_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_SOUTH
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_7_3 = {
    .platformIndex = 0x5,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_8_1 = {
    .platformIndex = 0x5,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_8_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_NORTH
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_8_3 = {
    .platformIndex = 0x5,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_9_1 = {
    .platformIndex = 0x6,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_9_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_9_3 = {
    .platformIndex = 0x6,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_10_1 = {
    .platformIndex = 0x6,
    .movePlayer = FALSE,
    .dummy04 = 0x0,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_10_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_10_3 = {
    .platformIndex = 0x6,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_11_1 = {
    .platformIndex = 0x9,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_11_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_11_3 = {
    .platformIndex = 0x9,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_12_1 = {
    .platformIndex = 0x9,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_12_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_12_3 = {
    .platformIndex = 0x9,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_13_1 = {
    .platformIndex = 0xA,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_13_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_13_3 = {
    .platformIndex = 0xA,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_14_1 = {
    .platformIndex = 0xA,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_14_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_14_3 = {
    .platformIndex = 0xA,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_15_1 = {
    .platformIndex = 0xB,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_15_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_SOUTH
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_15_3 = {
    .platformIndex = 0xB,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_16_1 = {
    .platformIndex = 0xB,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_16_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_NORTH
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_16_3 = {
    .platformIndex = 0xB,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_17_1 = {
    .platformIndex = 0xC,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_17_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_17_3 = {
    .platformIndex = 0xC,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_18_1 = {
    .platformIndex = 0xC,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x9,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_18_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_18_3 = {
    .platformIndex = 0xC,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x9,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_19_1 = {
    .platformIndex = 0xD,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_19_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_19_3 = {
    .platformIndex = 0xD,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x11,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_20_1 = {
    .platformIndex = 0xD,
    .movePlayer = FALSE,
    .dummy04 = 0x2,
    .finalTileXOffset = -0x11,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_20_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_20_3 = {
    .platformIndex = 0xD,
    .movePlayer = TRUE,
    .dummy04 = 0x2,
    .finalTileXOffset = 0x11,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_21_1 = {
    .platformIndex = 0x11,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_21_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_NORTH
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_21_3 = {
    .platformIndex = 0x11,
    .movePlayer = FALSE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_22_1 = {
    .platformIndex = 0x11,
    .movePlayer = FALSE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_22_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_SOUTH
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_22_3 = {
    .platformIndex = 0x11,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_23_1 = {
    .platformIndex = 0x10,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_23_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_EAST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_23_3 = {
    .platformIndex = 0x10,
    .movePlayer = FALSE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_24_1 = {
    .platformIndex = 0x10,
    .movePlayer = FALSE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdSetMapObjectAnimationParams sUnkMapEventCmdParamsB2F_24_2 = {
    .mapObjLocalID = LOCALID_PLAYER,
    .movementAction = MOVEMENT_ACTION_JUMP_DISTORTION_WORLD_WEST
};

static const DistWorldEventCmdMovePlatformParams sUnkMapEventCmdParamsB2F_24_3 = {
    .platformIndex = 0x10,
    .movePlayer = TRUE,
    .dummy04 = 0x1,
    .finalTileXOffset = 0x0,
...
static const DistWorldEventCmdStartScriptParams sUnkMapEventCmdParamsB3F_1_1 = {
    .scriptID = 0x2
};

static const DistWorldEventCmdSetDistortionWorldProgressParams sUnkMapEventCmdParamsB3F_1_2 = {
    .progress = 0x6
};
...
static const DistWorldEventCmdCascadeDownParams sMapEventCmdParamsB4F_Waterfall = {
    {
        .movementAxis = AXIS_Y,
...
static const DistWorldEventCmdSetGiratinaAnimationFlagParams sUnkMapEventCmdParamsB4F_1_2 = {
...
static const DistWorldEventCmdSetGiratinaAnimationFlagParams sUnkMapEventCmdParamsB4F_2_2 = {
...
static const DistWorldEventCmdCascadeUpParams sMapEventCmdParamsB5F_Waterfall = {
    {
        .movementAxis = AXIS_Y,
...
static const DistWorldEventCmdStartScriptParams sUnkMapEventCmdParamsB7F_1_1 = {
    .scriptID = 0x4
};

static const DistWorldEventCmdSetDistortionWorldProgressParams sUnkMapEventCmdParamsB7F_1_2 = {
    .progress = 0x9
};
...
static const DistWorldEventCmdPersistedBoulderPuzzleFlagParams sUnkMapEventCmdParamsGiratinaRoom_1_1 = {
...
static const DistWorldEventCmd sUnkMapEventGiratinaRoom_1[] = {
    ...
    {
        .kind = EVENT_CMD_SET_PERSISTED_BOULDER_PUZZLE_FLAG,
        .params = &sUnkMapEventCmdParamsGiratinaRoom_1_1,
    },
    { EVENT_CMD_END, NULL }
};

static const DistWorldEventCmdPersistedBoulderPuzzleFlagParams sUnkMapEventCmdParamsGiratinaRoom_2_1 = {
    .flagIndex = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_GIRATINA_ROOM_PLATFORMS_VISIBLE
};
...
static const DistWorldEventCmd sUnkMapEventGiratinaRoom_2[] = {
    ...
    {
        .kind = EVENT_CMD_CLEAR_PERSISTED_BOULDER_PUZZLE_FLAG,
        .params = &sUnkMapEventCmdParamsGiratinaRoom_2_1,
    },
    { EVENT_CMD_END, NULL }
};

static const DistWorldEventCmdStartScriptParams sUnkMapEventCmdParamsGiratinaRoom_3_1 = {
    .scriptID = 0x7
};
...
static const DistWorldEventCmdSetDistortionWorldProgressParams sUnkMapEventCmdParamsGiratinaRoom_3_3 = {
    .progress = 0xB
};
...
static const DistWorldEventCmdSetDistortionWorldProgressParams sUnkMapEventCmdParamsGiratinaRoom_4_2 = {
    .progress = 0xC
};
...
static const DistWorldEventCmdSetDistortionWorldProgressParams sUnkMapEventCmdParamsGiratinaRoom_5_1 = {
    .progress = 0xD
};

static const DistWorldEventCmdStartScriptParams sUnkMapEventCmdParamsGiratinaRoom_5_2 = {
    .scriptID = 0x8
};
...
static const DistWorldEventCmd sUnkMapEventGiratinaRoom_5[] = {
    ...
    {
        .kind = EVENT_CMD_PLAY_GIRATINA_ROOM_APPEARANCE,
        .params = NULL,
    },
    {
        .kind = EVENT_CMD_START_SCRIPT,
...
static const DistWorldObjectEvent sMapObjectEventB6F_MespritBoulderInPit = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_BOULDER_IN_B6F_PIT,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
...
static const DistWorldObjectEvent sMapObjectEventB6F_AzelfBoulderInPit = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_BOULDER_IN_B6F_PIT,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
...
static const DistWorldObjectEvent sMapObjectEventB6F_UxieBoulderInPit = {
    .flagCond = FLAG_COND_BOULDER_PUZZLE_TRUE,
    .flagCondVal = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_BOULDER_IN_B6F_PIT,
    .rotated = FALSE,
    .rotationAngle = 0x0,
    .objEvent = {
