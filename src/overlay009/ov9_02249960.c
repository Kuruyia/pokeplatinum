...
static void InitPersistedData(DistWorldSystem *param0);
...
static void StartCalculateTask(DistWorldSystem *param0);
static void FinishCalculateRask(DistWorldSystem *param0);
static void Task_Calculate(SysTask *param0, void *param1);
...
static void InitEdgeColors(DistWorldSystem *param0);
static void Dummy02249F84(DistWorldSystem *param0);
static void InitMapObjectFlags(DistWorldSystem *param0);
static void Dummy02249F98(DistWorldSystem *param0);
...
static void InitPlayer(DistWorldSystem *param0);
static void ResetPlayer(DistWorldSystem *param0);
...
static void InitMapElements(DistWorldSystem *param0);
static void FreeMapElements(DistWorldSystem *param0);
...
static void LoadMapFiles(DistWorldSystem *param0, enum MapHeader mapHeaderID, int param2);
static void LoadActiveMapFile(DistWorldSystem *param0, enum MapHeader mapHeaderID);
static void LoadInactiveMapFile(DistWorldSystem *param0, enum MapHeader mapHeaderID);
static void DistWorldMapFile_Free(DistWorldMapFile *file);
static void FreeMapFiles(DistWorldSystem *param0);
static void FreeActiveMapFile(DistWorldSystem *param0);
static void FreeInactiveMapFile(DistWorldSystem *param0);
static void MoveActiveMapFileToInactive(DistWorldSystem *param0);
static void MoveInactiveMapFileToActive(DistWorldSystem *param0);
...
static void FinishCalculateRask(DistWorldSystem *system)
{
    DistWorldCalculationTask *calculationTask = &system->calculationTask;
