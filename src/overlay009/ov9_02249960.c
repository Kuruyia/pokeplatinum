...
enum MapObjectRotatorValidity {
    ...
    MAP_OBJECT_ROTATOR_VALIDITY_OUTDATED,
    MAP_OBJECT_ROTATOR_VALIDITY_OUTDATED_ANIM_OBJ,
};
...
static void InitMapObjectRotatorManager(DistWorldSystem *param0, int param1);
static void DistWorldMapObjectRotatorManager_PrepareRotator(DistWorldMapObjectRotatorManager *param0, DistWorldMapObjectRotator *param1, Billboard *param2);
static void DistWorldMapObjectRotatorManager_FreeRotatorAnimObj(DistWorldMapObjectRotatorManager *param0, DistWorldMapObjectRotator *param1);
static void DistWorldMapObjectRotatorManager_FreeRotator(DistWorldMapObjectRotatorManager *param0, DistWorldMapObjectRotator *param1);
static void FreeMapObjectRotatorManager(DistWorldSystem *param0);
static void BindMapObjectRotator(DistWorldSystem *param0, MapObject *param1, int param2);
static void BindMapObjectRotatorWithBillboard(DistWorldSystem *param0, Billboard *param1, int param2);
static void UnbindMapObjectRotatorWithBillboard(DistWorldSystem *param0, const Billboard *param1);
static void TickAllMapObjectRotators(DistWorldSystem *param0);
static void MapObjectRotatorBillboardCallback(Billboard *param0, void *param1);
static void RotateMapObject(DistWorldSystem *param0, MapObject *param1, int param2, int param3);
...
static void InitMapObjectRotatorManager(DistWorldSystem *system, int rotatorCount)
{
    ...
    HeapExp_FndInitAllocator(&mapObjRotatorMan->fndAllocator, HEAP_ID_FIELD1, 4);
...
static void DistWorldMapObjectRotatorManager_PrepareRotator(DistWorldMapObjectRotatorManager *mapObjRotatorMan, DistWorldMapObjectRotator *mapObjRotator, Billboard *billboard)
{
    ...
    mapObjRotator->animObj = NNS_G3dAllocAnmObj(&mapObjRotatorMan->fndAllocator, mapObjRotatorMan->anim, model);
...
static void DistWorldMapObjectRotatorManager_FreeRotatorAnimObj(DistWorldMapObjectRotatorManager *mapObjRotatorMan, DistWorldMapObjectRotator *mapObjRotator)
{
    if (mapObjRotator->animObj != NULL) {
        NNS_G3dFreeAnmObj(&mapObjRotatorMan->fndAllocator, mapObjRotator->animObj);
...
{
    DistWorldMapObjectRotatorManager_FreeRotatorAnimObj(mapObjRotatorMan, mapObjRotator);
...
static int DistWorldMapObjectRotator_GetValidity(DistWorldMapObjectRotator *mapObjRotator)
{
    if (mapObjRotator->mapObj != NULL) {
        if (!sub_02062CF8(mapObjRotator->mapObj)) {
            return MAP_OBJECT_ROTATOR_VALIDITY_OUTDATED;
            ...
            return MAP_OBJECT_ROTATOR_VALIDITY_OUTDATED_ANIM_OBJ;
        }
...
static void FreeMapObjectRotatorManager(DistWorldSystem *system)
{
    ...
    for (int i = 0; i < mapObjRotatorMan->count; i++, iter++) {
        DistWorldMapObjectRotatorManager_FreeRotator(mapObjRotatorMan, iter);
    }
...
static void TickMapObjectRotator(DistWorldSystem *system, DistWorldMapObjectRotatorManager *mapObjRotatorMan, DistWorldMapObjectRotator *mapObjRotator)
{
    ...
    int state = DistWorldMapObjectRotator_GetValidity(mapObjRotator);

    if (state == MAP_OBJECT_ROTATOR_VALIDITY_OUTDATED) {
        DistWorldMapObjectRotatorManager_FreeRotator(mapObjRotatorMan, mapObjRotator);
        return;
    } else if (state == MAP_OBJECT_ROTATOR_VALIDITY_OUTDATED_ANIM_OBJ) {
        DistWorldMapObjectRotatorManager_FreeRotatorAnimObj(mapObjRotatorMan, mapObjRotator);
    }
...
static void InitFog(DistWorldSystem *system)
{
    ...
    int i = 0;
    char densityTable[FOG_DENSITY_TABLE_SIZE];

    do {
        densityTable[i] = (FOG_DENSITY / FOG_DENSITY_TABLE_SIZE) * i;
        i++;
    } while (i < FOG_DENSITY_TABLE_SIZE);
