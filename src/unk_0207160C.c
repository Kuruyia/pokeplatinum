...
void sub_0207160C(FieldSystem *fieldSystem)
{
    ...
    if (v4->unk_14) {
        ...
        v6.y = v5;
        MapPropManager_LoadOne(fieldSystem->mapPropManager, fieldSystem->areaDataManager, MAP_PROP_MODEL_ID_IRON_ISLAND_LIFT_PLATFORM, &v6, NULL, fieldSystem->mapPropAnimationManager);
        v1 = MapPropManager_FindLoadedPropByModelID(fieldSystem->mapPropManager, MAP_PROP_MODEL_ID_IRON_ISLAND_LIFT_PLATFORM);
    } else {
