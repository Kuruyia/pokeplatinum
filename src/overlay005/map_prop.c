...
void MapPropManager_Load(NARC *landDataNARC, const int mapPropFilesSize, AreaDataManager *const areaDataManager, MapPropManager *mapPropManager, MapPropAnimationManager *param4)
{
    ...
    for (i = 0; i < MAX_LOADED_MAP_PROPS; i++) {
        ...
        if (i < mapPropFilesCount) {
            ...
            MapPropAnimationManager_AddAllAnimationsToRenderObj(loadedProp->modelID, &loadedProp->renderObj, param4);
        } else {
            VecFx32 nullVector = { 0, 0, 0 };
...
u8 MapPropManager_LoadOne(MapPropManager *mapPropManager, AreaDataManager *const areaDataManager, const int modelID, const VecFx32 *position, const VecFx32 *rotation, MapPropAnimationManager *param5)
{
    u8 i;
    ...
    for (i = 0; i < MAX_LOADED_MAP_PROPS; i++) {
        ...
        if (loadedProp->loaded == FALSE) {
            ...
            MapPropManager_InitRenderObj(loadedProp->modelID, areaDataManager, &loadedProp->renderObj, &loadedProp->model);
            MapPropAnimationManager_AddAnimationToRenderObj(loadedProp->modelID, 0, FALSE, &loadedProp->renderObj, param5);
