...
static BOOL FieldTask_UseSurf(FieldTask *task)
{
    ...
    case 5:
        ...
        if (PlayerAvatar_MapDistortionState(taskEnv->playerAvatar) == AVATAR_DISTORTION_STATE_NONE) {
            ...
            DistWorldSurfMountRenderer_SetMultipleFlags(taskEnv->unk_28, DIST_WORLD_SURF_MOUNT_RENDERER_FLAG_MASK_NO_TICK);
    ...
    case 0:
        if (LocalMapObj_IsAnimationSet(v0->unk_10) == 1) {
            ...
            if (distortionState == AVATAR_DISTORTION_STATE_NONE) {
                ...
                DistWorldSurfMountRenderer_ClearMultipleFlags(v0->unk_14, DIST_WORLD_SURF_MOUNT_RENDERER_FLAG_MASK_NO_TICK);
