...
BOOL ov5_021D433C(FieldSystem *fieldSystem, UnkStruct_ov5_021D432C *param1)
{
    ...
    case 0: {
        ...
        int v4;
        int v5[] = {
            MAP_PROP_MODEL_ID_DOOR01,
            MAP_PROP_MODEL_ID_BROWN_WOODEN_DOOR,
            MAP_PROP_MODEL_ID_GREEN_WOODEN_DOOR,
            MAP_PROP_MODEL_ID_IRON_DOOR,
            MAP_PROP_MODEL_ID_JUBILIFE_CITY_BUILDING_DOOR,
            MAP_PROP_MODEL_ID_POKECENTER_DOOR,
            MAP_PROP_MODEL_ID_POKECENTER_INSIDE_DOOR,
            MAP_PROP_MODEL_ID_GTS_INSIDE_DOOR,
            MAP_PROP_MODEL_ID_HEARTHOME_GYM_INSIDE_DOOR,
            MAP_PROP_MODEL_ID_BLUE_DOOR,
            MAP_PROP_MODEL_ID_IRON_DOOR_2,
            MAP_PROP_MODEL_ID_YELLOW_WOODEN_DOOR,
            MAP_PROP_MODEL_ID_BLUE_WOODEN_DOOR,
            MAP_PROP_MODEL_ID_MANSION_DOOR,
            MAP_PROP_MODEL_ID_VEILSTONE_DPT_STORE_DOOR,
            MAP_PROP_MODEL_ID_GYM_DOOR,
            MAP_PROP_MODEL_ID_CARD_DOOR,
            MAP_PROP_MODEL_ID_POKECENTER_INSIDE_COUNTER_DOOR,
            MAP_PROP_MODEL_ID_HOTEL_GRAND_LAKE_DOOR,
            MAP_PROP_MODEL_ID_ELEVATOR_DOOR
        };
        ...
        if (v1) {
            ...
            v7 = MapPropAnimationManager_GetPropAnimationCount(fieldSystem->mapPropAnimationManager, v4);
            param1->unk_1E = v7;
            v8 = AreaDataManager_GetMapPropTexture(fieldSystem->areaDataManager);

            ov5_021D41C8(fieldSystem->mapPropAnimationManager, fieldSystem->mapPropOneShotAnimationManager, 1, v4, MapProp_GetRenderObj(v2), MapProp_GetModel(v2), v8, v7, 1, 0);
        } else {
            GF_ASSERT(FALSE);
            return 1;
        }
    ...
    case 1: {
        ...
        v9 = MapPropOneShotAnimationManager_GetAnimationMapPropModelIDByTag(fieldSystem->mapPropOneShotAnimationManager, 1);
        ...
        MapPropOneShotAnimationManager_PlayAnimationWithSoundEffect(fieldSystem->mapPropOneShotAnimationManager, 1, v11, v10);
    }
        (param1->unk_00)++;
        break;
    case 2: {
        ...
        v12 = ov5_021D42F0(fieldSystem->mapPropOneShotAnimationManager, 1);
    ...
    case 4:
        ...
        if (LocalMapObj_CheckAnimationFinished(v0) == 1) {
            ...
            MapObject_SetHidden(v0, 1);
            {
                ...
                v13 = MapPropOneShotAnimationManager_GetAnimationMapPropModelIDByTag(fieldSystem->mapPropOneShotAnimationManager, 1);
                ...
                MapPropOneShotAnimationManager_PlayAnimationWithSoundEffect(fieldSystem->mapPropOneShotAnimationManager, 1, v15, v14);
            }
            (param1->unk_00)++;
        }
        break;
    case 5: {
        ...
        v16 = ov5_021D42F0(fieldSystem->mapPropOneShotAnimationManager, 1);

        if (v16) {
            MapPropOneShotAnimationManager_UnloadAnimationByTag(fieldSystem->mapPropAnimationManager, fieldSystem->mapPropOneShotAnimationManager, 1);
            return 1;
        }
    } break;
    }
...
BOOL ov5_021D4858(FieldSystem *fieldSystem, UnkStruct_ov5_021D432C *param1, const u8 param2)
{
    ...
    case 0: {
        ...
        int v4;
        int v5[] = {
            MAP_PROP_MODEL_ID_POKECENTER_STAIR_UP_LEFT,
            MAP_PROP_MODEL_ID_POKECENTER_STAIR_DOWN_LEFT,
            MAP_PROP_MODEL_ID_POKECENTER_STAIR_UP_RIGHT,
            MAP_PROP_MODEL_ID_POKECENTER_STAIR_DOWN_RIGHT
        };
        ...
        if (v1) {
            ...
            ov5_021D41C8(fieldSystem->mapPropAnimationManager, fieldSystem->mapPropOneShotAnimationManager, 2, v4, MapProp_GetRenderObj(v2), MapProp_GetModel(v2), v7, 1, 1, 1);
        } else {
            GF_ASSERT(FALSE);
            return 1;
        }
    ...
    case 1:
        ov5_021D1744(1);
        MapPropOneShotAnimationManager_PlayAnimationWithSoundEffect(fieldSystem->mapPropOneShotAnimationManager, 2, 0, 1557);
    ...
    case 5: {
        ...
        v10 = ov5_021D42F0(fieldSystem->mapPropOneShotAnimationManager, 2);

        if (v10 && IsScreenTransitionDone()) {
            MapPropOneShotAnimationManager_UnloadAnimationByTag(fieldSystem->mapPropAnimationManager, fieldSystem->mapPropOneShotAnimationManager, 2);
...
BOOL ov5_021D4A24(FieldSystem *fieldSystem, UnkStruct_ov5_021D432C *param1, const u8 param2)
{
    ...
    case 0: {
        ...
        if (v1) {
            ...
            v7 = AreaDataManager_GetMapPropTexture(fieldSystem->areaDataManager);
            ov5_021D41C8(fieldSystem->mapPropAnimationManager, fieldSystem->mapPropOneShotAnimationManager, 2, v4, MapProp_GetRenderObj(v2), MapProp_GetModel(v2), v7, 1, 1, 0);
        } else {
            GF_ASSERT(FALSE);
            return 1;
        }
    ...
    case 4: {
        ...
        v9 = ov5_021D42F0(fieldSystem->mapPropOneShotAnimationManager, 2);
...
static BOOL ov5_021D4BC8(FieldTask *param0)
{
    ...
    v0 = ov5_021D42F0(fieldSystem->mapPropOneShotAnimationManager, *v2);
...
void ov5_021D4BF4(FieldSystem *fieldSystem, const int param1, const int param2, const u8 param3)
{
    ...
    if (v0) {
        ...
        v6 = MapPropAnimationManager_GetPropAnimationCount(fieldSystem->mapPropAnimationManager, v3);
        v7 = AreaDataManager_GetMapPropTexture(fieldSystem->areaDataManager);

        ov5_021D41C8(fieldSystem->mapPropAnimationManager, fieldSystem->mapPropOneShotAnimationManager, param3, v3, MapProp_GetRenderObj(v1), MapProp_GetModel(v1), v7, v6, 1, 0);
    } else {
        GF_ASSERT(FALSE);
    }
}
...
void ov5_021D4C88(FieldSystem *fieldSystem, const u8 param1)
{
    ...
    v0 = MapPropOneShotAnimationManager_GetAnimationMapPropModelIDByTag(fieldSystem->mapPropOneShotAnimationManager, param1);
    v3 = MapPropAnimationManager_GetPropAnimationCount(fieldSystem->mapPropAnimationManager, v0);
    ...
    MapPropOneShotAnimationManager_PlayAnimationWithSoundEffect(fieldSystem->mapPropOneShotAnimationManager, param1, v2, v1);
}
...
{
    MapPropOneShotAnimationManager_UnloadAnimationByTag(fieldSystem->mapPropAnimationManager, fieldSystem->mapPropOneShotAnimationManager, param1);
}
...
void ov5_021D4D78(const int param0, const int param1, const int param2, FieldSystem *fieldSystem)
{
...

    {
        ...
        v0 = MapPropAnimationManager_AddAnimationToRenderObj(v3, param2, 1, v5, fieldSystem->mapPropAnimationManager);
        GF_ASSERT(v0);
    }
    {
        MapPropAnimation *v6;

        v6 = MapPropAnimationManager_GetAnimation(v3, param2, fieldSystem->mapPropAnimationManager);
