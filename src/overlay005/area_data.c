...
AreaDataManager *AreaDataManager_Alloc(const int areaDataArchiveID, MapPropAnimationManager *param1)
{
...
void AreaDataManager_Load(AreaDataManager *areaDataManager)
{
    ...
    int i;
    u16 mapPropModelID;
    int mapPropModelAnimeListNARCFileCount = MapPropAnimationManager_GetAnimeListNARCFileCount(loadData->unk_04);
    ...
    for (i = 0; i < loadData->mapPropModelIDsCount; i++) {
        ...
        if (mapPropModelID < mapPropModelAnimeListNARCFileCount) {
            ...
            MapPropAnimationManager_LoadPropAnimationsSimple(mapPropModelID, mapPropModel, areaDataManager->mapPropTexture, loadData->unk_04);
        }
