...
static BOOL FieldMap_Exit(OverlayManager *overlayMan, int *param1)
{
    ...
    case 0:
        ...
        {
            GF_ASSERT(fieldSystem->mapPropAnimationManager != 0);
...
static void ov5_021D134C(FieldSystem *fieldSystem, u8 param1)
{
    ...
    if ((param1 & 8) != 0) {
        MapPropAnimationManager_AdvanceAnimations(fieldSystem->mapPropAnimationManager);
    }
...
static void ov5_021D1790(FieldSystem *fieldSystem)
{
    ...
    fieldSystem->mapPropAnimationManager = MapPropAnimationManager_New();
...

    {
        ...
        fieldSystem->areaDataManager = AreaDataManager_Alloc(areaDataArchiveID, fieldSystem->mapPropAnimationManager);
...
static void ov5_021D17EC(FieldSystem *fieldSystem)
{
    fieldSystem->unk_28 = ov5_021E9084(fieldSystem->mapMatrix, fieldSystem->areaDataManager, fieldSystem->mapPropAnimationManager, fieldSystem->unk_60);
