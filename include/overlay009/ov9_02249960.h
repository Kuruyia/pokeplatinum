...
enum DistWorldPersistedBoulderPuzzleFlag {
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_BOULDER_IN_B5F = 0,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_BOULDER_IN_B5F,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_BOULDER_IN_B5F,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_BOULDER_IN_B6F_OUTSIDE,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_BOULDER_IN_B6F_OUTSIDE,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_BOULDER_IN_B6F_OUTSIDE,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_BOULDER_IN_B6F_HOLE,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_BOULDER_IN_B6F_HOLE,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_BOULDER_IN_B6F_HOLE,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_DUMMY9,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_TUTO_SEEN,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_TUTO_SEEN,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_TUTO_SEEN,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_IN_B6F,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_IN_B6F,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_IN_B6F,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_GIRATINA_ROOM_PLATFORMS_VISIBLE,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_COUNT,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_INVALID = DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_COUNT,
};
