...
enum DistWorldPersistedBoulderPuzzleFlag {
    ...
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_MESPRIT_BOULDER_IN_B6F_PIT,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_AZELF_BOULDER_IN_B6F_PIT,
    DIST_WORLD_PERSISTED_BOULDER_PUZZLE_FLAG_UXIE_BOULDER_IN_B6F_PIT,
