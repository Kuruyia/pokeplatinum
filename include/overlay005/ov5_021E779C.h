...
u8 ov5_021E935C_CalculateLoadedMapIndexForPlayer(const u32 param0, const int param1);
u8 ov5_021E9390(const int param0, const u8 param1, const UnkStruct_ov5_021E8F60 *param2);
int ov5_021E9560_GetMapMatrixIndex(const UnkStruct_ov5_021E8F60 *param0, const u8 param1);
BOOL ov5_021E9580(const UnkStruct_ov5_021E8F60 *param0, const int param1, const int param2, u8 *param3);
const BDHC *LoadedMaps_GetBDHC(const UnkStruct_ov5_021E8F60 *param0, const u8 param1);
u16 const *LoadedMaps_GetMovementPermissions(const UnkStruct_ov5_021E8F60 *param0, const u8 param1);
...
void ov5_021EA6D8_SetMapMatrix(UnkStruct_ov5_021E8F60 *param0, MapMatrix *param1);
